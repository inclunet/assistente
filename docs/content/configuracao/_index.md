...
Guias de configuração de provedores, voz, integrações e ferramentas.

| Documento | Descrição |
|---|---|
| [Provedores LLM](PROVIDER_CONFIGURATION/) | OpenAI, Claude, DeepSeek, Groq, Ollama e mais 10 provedores |
| [Voz (TTS e STT)](SPEECH_CONFIGURATION/) | Text-to-Speech, Speech-to-Text e Wake Word |
