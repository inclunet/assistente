...
1. Crie um app Slack com Socket Mode e bot token (scopes mínimos: ver [guia Slack](docs/content/configuracao/SLACK_CHANNEL_SETUP.md); inclua `files:read` para anexos inbound e `files:write` para upload outbound)
