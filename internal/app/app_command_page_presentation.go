...
var commandProductPagePresentation = []commandUINavigation{
	...
	{id: "command_settings.create.open", route: "ui/command-settings/create/open", uiAction: true, ptName: "Novo item de configuração de comandos", ptDesc: "Abrir formulário na lista ativa de camadas, bindings ou regras", enName: "New command settings item", enDesc: "Open a form in the active layers, bindings, or rules list", esName: "Nuevo elemento de configuración de comandos", esDesc: "Abrir un formulario en la lista activa de capas, bindings o reglas"},
