...
func (s *TokenService) GetConversationStats(conversationID string, contextLimit int) (*TokenStats, error) {
...
func (s *TokenService) GetTurnStats(conversationID, turnID string) (*TokenStats, error) {
...
func (s *TokenService) GetRecentTokenCount(conversationID string, messageLimit int) (int, error) {
...
func (s *TokenService) CheckContextThreshold(conversationID string, contextLimit int, threshold float64) (bool, float64, error) {
