...
// ErrFSTrustNotWired indica que o bind FSTrust ainda não recebeu controller/session.
var ErrFSTrustNotWired = errors.New("wailsapi: fstrust bind not wired")
...
// ErrMessagingNotWired indica que o bind Messaging ainda não recebeu controller/session.
var ErrMessagingNotWired = errors.New("wailsapi: messaging bind not wired")
...
// ErrSpeechNotWired indica que o bind Speech ainda não recebeu controller/session/dispatcher.
var ErrSpeechNotWired = errors.New("wailsapi: speech bind not wired")

// ErrWorkspaceNotWired indica que o bind Workspace ainda não recebeu controller/session.
var ErrWorkspaceNotWired = errors.New("wailsapi: workspace bind not wired")
...
// ErrACPOptionsNotWired indica que o bind ACPOptions ainda não recebeu manager/session.
var ErrACPOptionsNotWired = errors.New("wailsapi: acp options bind not wired")

// ErrACPRegistryNotWired indica que o bind ACPRegistry ainda não recebeu
// session/registry/catalogOf.
var ErrACPRegistryNotWired = errors.New("wailsapi: acp registry bind not wired")

// ErrACPWorkDirNotWired indica que o bind ACPWorkDir ainda não recebeu manager/session.
var ErrACPWorkDirNotWired = errors.New("wailsapi: acp workdir bind not wired")
