...
var goldenBuiltinCatalogMetadata = map[string]tools.CatalogMetadata{
	...
	"memory":                {Category: "app", Class: "app_tool", Package: "basic", Risk: "write"},
	"mcp_server":            {Category: "mcp", Class: "mcp_management", Package: "mcp", Risk: "write", Tags: []string{"mcp", "servers", "configuration"}},
	"send_message":          {Category: "app", Class: "app_tool", Package: "basic", Risk: "network"},
	"validate_pairing_code": {Category: "app", Class: "app_tool", Package: "basic", Risk: "write"},
