...
- Navigate: assistente://navigate/{route} (routes: history, tasklists, settings, profiles, providers, credentials, skills, mcp, channels, allowlists, settings/network-allowlist, help, about, update)
