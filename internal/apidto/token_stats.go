// Package apidto concentra DTOs da borda Wails (AEP-0088 D5).
// Controllers e binds importam daqui; não de controllers nem de aliases em app.
package apidto

// TokenStats representa estatísticas de tokens de uma conversa ou turno —
// resposta estável da API Wails para o frontend.
