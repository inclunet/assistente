...
type ToolInvocation struct {
	UUIDModel
	UserID        string `json:"userId" gorm:"not null;index:idx_tool_invocations_user_origin,priority:1;index:idx_tool_invocations_user_tool_started,priority:1;index:idx_tool_invocations_user_status_queued,priority:1;index:idx_tool_invocations_user_dryrun_queued,priority:1"`
	ToolCatalogID string `json:"toolCatalogId" gorm:"not null;index:idx_tool_invocations_user_tool_started,priority:2"`

	OriginType         string  `json:"originType" gorm:"not null;index:idx_tool_invocations_user_origin,priority:2"`
	...
	QueuedAt     time.Time  `json:"queuedAt" gorm:"not null;index:idx_tool_invocations_user_status_queued,priority:3;index:idx_tool_invocations_user_dryrun_queued,priority:3"`
