...
//
// TurnID agrupa mensagens conversacionais de um turno e aponta para a mensagem
// user que o iniciou. Chamadas e resultados de ferramentas pertencem
// exclusivamente a ToolInvocation.
