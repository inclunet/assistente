...
| Persistência do catálogo | `internal/mcp/repository.go`, `internal/mcp/catalog_sync.go` | Sync/storage do catálogo (acoplado ao MCP) |
...
- [ ] **F2/#120**: `tool_catalog` num pacote próprio fora de `internal/mcp`; mesma tabela/migrações; MCP, builtins e demais call sites consumindo o novo serviço.
