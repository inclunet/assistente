...
test.describe('MessageNode — ArrowRight/Left thread expand/collapse', () => {
  test('ArrowRight expande thread e foca no primeiro filho', async ({ page, wails }) => {
    ...
    const messagesWithChildren = [
      {
        message: { id: '01926b90-0000-7000-8000-100000000001', conversationId: '01926b90-0000-7000-8000-000000000001', role: 'user', content: 'Msg pai', createdAt: now },
        children: [],
        childCount: 1,
      },
      {
    ...
    const childrenResponse = [
      {
        message: { id: '01926b90-0000-7000-8000-100000001001', conversationId: '01926b90-0000-7000-8000-000000000001', role: 'assistant', content: 'Resposta interna', createdAt: now, internal: true },
        children: [],
        childCount: 0,
      },
    ];
...
test.describe('MessageNode — PageDown/PageUp navigation', () => {
  test('PageDown pula múltiplas mensagens', async ({ page, wails }) => {
    ...
    const manyMessages = Array.from({ length: 15 }, (_, i) => ({
      message: {
        id: `01926b90-0000-7000-8000-1${String(i + 1).padStart(11, '0')}`,
...
test.describe('MessageNode — ARIA attributes', () => {
  test('mensagens com filhos têm aria-expanded', async ({ page, wails }) => {
    ...
    const messagesWithAndWithoutChildren = [
      {
        message: { id: '01926b90-0000-7000-8000-100000000001', conversationId: '01926b90-0000-7000-8000-000000000001', role: 'user', content: 'Com filhos', createdAt: now },
        children: [],
        childCount: 2,
      },
      {
        message: { id: '01926b90-0000-7000-8000-100000000002', conversationId: '01926b90-0000-7000-8000-000000000001', role: 'assistant', content: 'Sem filhos', createdAt: now },
        children: [],
        childCount: 0,
      },
    ];
