const ptBR = {
  translation: {
    ...
    commandSettings: {
      ...
      presentation: { help: 'Personalize o título e o ícone exibidos no Stream Deck. O fallback se aplica somente ao título: vazio usa o nome do comando localizado.', fallback: 'Fallback somente do título: vazio usa o nome do comando localizado naquele idioma.', icon: { label: 'Ícone', hint: 'Ícones desconhecidos permanecem disponíveis para substituição ou remoção.', none: 'Sem ícone', settings: 'Configurações', chat: 'Conversa', folder: 'Pasta', play: 'Executar', stop: 'Parar', back: 'Voltar', star: 'Estrela', unavailable: 'Ícone não disponível: {{icon}}' }, locales: { ptBR: 'Português (Brasil)', en: 'English', es: 'Español' }, invalid: 'Revise os títulos personalizados antes de salvar.', invalidNul: 'O título não pode conter o caractere NUL.', invalidLength: 'O título deve ter no máximo 256 codepoints.' },
