const ptBR = {
  translation: {
    ...
    menu: {
      ...
      navLabelPlain: 'Menu de navegação',
    ...
    commandPalette: {
      ...
      available: 'Comando disponível.',
      unavailable: 'Comando indisponível.',
      loading: 'Carregando comandos…',
      error: 'Falha ao carregar comandos.',
      executionFailed: 'Não foi possível executar o comando.',
      executionSucceeded: 'Comando executado.',
      executionCancelled: 'A execução do comando foi cancelada.',
      executionUnknown: 'Não foi possível confirmar a execução do comando.',
      executionSuppressed: 'Este acionamento está desativado na configuração de comandos.',
      ...
      arguments: {
        ...
        description: 'Preencha os argumentos aceitos pelo comando. Eles serão enviados somente nesta execução.',
        submit: 'Executar',
        invalid: 'Informe um valor válido para este argumento.',
        unsupported: 'Este comando declara argumentos em um formato que a paleta não consegue editar.',
        chooseRequired: 'Selecione um valor',
        skip: 'Não informar',
        null: 'Valor nulo',
        provideValue: 'Informar valor',
        value: 'Valor',
        jsonHint: 'Informe um valor JSON.',
        toolSchemaTitle: 'Parâmetros de {{tool}}',
        toolSchemaLabel: 'Schema JSON da ferramenta',
        toolSchemaHint: 'Use este schema como referência para preencher arguments_json. O backend valida e confirma a execução.',
        toolSchemaUnavailable: 'Não foi possível carregar o schema da ferramenta. A execução ainda será validada pelo backend.',
      },
    },
    ...
    commandShortcutCapture: {
      ...
      simple: 'Combinação simples',
      sequence: 'Sequência de duas etapas',
      sequenceHint: 'Grave uma combinação com Control, Alt ou Meta, solte as teclas e depois pressione uma tecla sem modificadores. O tipo escolhido se aplica à próxima gravação.',
      sequenceStarted: 'Gravação de sequência iniciada. Pressione a primeira combinação com Control, Alt ou Meta.',
      nextStep: 'Primeira etapa: {{shortcut}}. Solte as teclas e pressione a segunda tecla, sem modificadores.',
      finalCapturing: 'Pressione a segunda tecla…',
      prefixInvalid: 'A primeira etapa exige Control, Alt ou Meta.',
      releaseFirst: 'Solte a primeira combinação antes de pressionar a segunda tecla sem modificadores.',
      buttonLabel: 'Capturar atalho de teclado',
      empty: 'Definir atalho',
      capturing: 'Pressione um atalho…',
      hint: 'Pressione Esc para cancelar. Tab cancela e move o foco.',
      started: 'Captura de atalho iniciada.',
      cancelled: 'Captura de atalho cancelada.',
      captured: 'Atalho capturado: {{shortcut}}.',
      invalid: 'Essa combinação de teclas não pode ser usada como atalho.',
    },
    ...
    chat: {
      ...
      pins: {
        button: 'Mensagens fixadas',
        buttonDescription: 'Listar mensagens fixadas nesta conversa',
        title: 'Mensagens fixadas',
        description: 'Lista das mensagens fixadas nesta conversa, incluindo mensagens de threads e ferramentas.',
        listLabel: 'Mensagens fixadas da conversa',
        loading: 'Carregando mensagens fixadas...',
      ...
      toolReadFileDone: 'Leu arquivo',
      toolEditFile: 'Editando arquivo',
      toolEditFileDone: 'Editou arquivo',
      toolListDirectory: 'Listando arquivos',
      toolListDirectoryDone: 'Listou arquivos',
      toolSearchFiles: 'Buscando arquivos',
      toolSearchFilesDone: 'Buscou arquivos',
      toolRunCommand: 'Executando comando',
      toolRunCommandDone: 'Executou comando',
      toolSearchWeb: 'Buscando na web',
      toolSearchWebDone: 'Buscou na web',
      toolAccessUrl: 'Acessando site',
      toolAccessUrlDone: 'Acessou site',
      toolMcpProvider: 'Consultando {{provider}}',
      toolMcpIntegration: 'Consultando uma integração conectada',
      toolGeneric: 'Executando ferramenta',
      toolGenericDone: 'Usou uma ferramenta',
      toolStatusRetrying: 'Tentando novamente',
      partialOutput: 'Saída parcial',
      partialOutputAvailable: 'Recebendo resultado parcial',
      parameters: 'Parâmetros',
      response: 'Resposta',
      showLess: 'Mostrar menos',
      showAll: 'Mostrar tudo',
      loadingToolDetails: 'Carregando detalhes...',
      toolDetailsUnavailable: 'Os detalhes desta execução não estão mais disponíveis.',
      toolDetailsLoadError: 'Não foi possível carregar os detalhes da ferramenta.',
    ...
    settingsPage: {
      ...
      tabs: {
        ...
        commands: 'Comandos e acionadores',
      },
    },
    ...
    commandSettings: {
      ...
      layerActionScope: 'Escopo da volta',
      layerActionOriginHelp: 'Usa uma regra manual já configurada. Voltar encerra a última ativação feita pela mesma origem; o Stream Deck e o teclado têm históricos separados.',
      foregroundProcessHint: 'Nome do executável, por exemplo obs64.exe. Não informe caminho, título da janela ou URL. A condição usa o programa em foco no pressionamento, antes de abrir o Assistente.',
      conditionDevice: 'Stream Deck conectado',
      conditionDeviceNumbered: '{{model}} — dispositivo {{index}}',
      advancedOptions: 'Opções avançadas do acionador',
      toolExecution: { adHocOnly: 'A execução de ferramentas é somente ad hoc; argumentos potencialmente sensíveis não podem ser salvos em um acionador permanente.' },
      conditionRowLabel: 'Condição {{index}}: {{field}}',
      unsupportedOriginCondition: 'Este acionador ou sua camada depende de uma condição indisponível nesta origem. Ele não será executado.',
      unavailableCondition: 'Condição indisponível: {{field}}',
      unavailableConditionValue: 'Valor indisponível neste contexto (preservado)',
      manualToggle: 'Alternar ativação',
      manualActionTitle: 'Ativação temporária', manualDurationSeconds: 'Duração (segundos)', manualDurationHint: 'Informe um valor entre 1 e 86400 segundos.', manualPin: 'Fixar camada', manualDeactivate: 'Desativar camada', manualBack: 'Voltar à última ativação', manualActivation: 'Ativação manual', manualActiveUntil: 'Ativa até {{date}}',
      tasklistSurface: 'Aba de lista de tarefas',
      keyboardAvailable: 'Os atalhos de navegação com Alt estão na camada Teclado padrão do aplicativo, sempre ativa. Camadas pessoais ativas podem substituir esses padrões. Listar workspaces e navegação aceitam combinações com Control, Alt ou Meta, sem condições contextuais ou conflitos. Campos de edição e modais têm prioridade.', scope: { label: 'Escopo', global: 'Global', workspace: 'Workspace atual' }, priority: 'Prioridade da camada: {{value}}',
      title: 'Comandos e acionadores', description: 'Gerencie camadas de comandos, os comandos e acionadores atribuídos a elas e suas regras de ativação.', layers: 'Camadas', commands: 'Comandos desta camada', whenActive: 'Quando esta camada fica ativa', noLayer: 'Selecione uma camada', builtinLayer: 'Camada integrada; seus padrões podem ser restaurados.', keyboardUnavailable: 'O teclado de comandos está indisponível neste momento. Os atalhos ainda não migrados continuam no sistema anterior.', prepareManual: 'Preparar ativação manual', activateManual: 'Ativar manualmente', deactivateManual: 'Desativar ativação manual', manualActivationHelp: 'Preparar cria uma regra persistente mediante confirmação do backend, mas não ativa automaticamente. Ativar aplica os bindings elegíveis. Para teclado, consulte os limites operacionais informados nesta tela. Desativar remove somente a ativação desta origem.',
      managers: { settings: 'Configurações da camada', commands: 'Comandos e acionadores', hint: 'Use as configurações da camada para gerenciar seus comandos e regras de ativação.', commandsCount: 'Acionadores: {{count}}', rulesCount: 'Regras de ativação: {{count}}' },
      columns: { name: 'Nome', description: 'Descrição', state: 'Estado', command: 'Comando', trigger: 'Acionador', binding: 'Binding', review: 'Revisão' }, states: { active: 'Ativa', inactive: 'Inativa', notEvaluated: 'Não avaliada', enabled: 'Habilitada', disabled: 'Desabilitada', readOnly: 'Somente leitura', needsReview: 'Precisa de revisão' }, sources: { keyboard: 'Teclado local', streamdeck: 'Stream Deck', palette: 'Paleta' }, deck: { status: 'Stream Deck: {{status}} ({{count}} dispositivo(s) informado(s) pelo runtime).', statuses: { connected: 'conectado', reconnecting: 'reconectando', degraded: 'degradado', disconnected: 'desconectado', unavailable: 'indisponível', unconfigured: 'não configurado', unknown: 'estado desconhecido' }, devices: { title: 'Dispositivos Stream Deck', keyCount: '{{count}} teclas' }, reasons: { openFailed: 'Não foi possível abrir o dispositivo.', reconnectBackoff: 'Nova tentativa de conexão aguardando intervalo de segurança.' } },
      actions: { newLayer: 'Nova camada', newBinding: 'Novo acionador', editLayer: 'Editar camada', editBinding: 'Editar acionador', deleteLayer: 'Excluir camada', deleteBinding: 'Excluir acionador', restore: 'Restaurar padrão', restoreAll: 'Restaurar configuração', restoreLayer: 'Restaurar camada', rebaseDefault: 'Rebasear padrão', upgradeDefaults: 'Atualizar padrões', suppress: 'Desativar padrão', toggleLayer: 'Alternar camada', pin: 'Fixar camada', deactivate: 'Desativar camada', back: 'Voltar à última ativação', enable: 'Habilitar', disable: 'Desabilitar', reload: 'Recarregar' },
      formExtra: { effect: 'Efeito', execute: 'Executar', suppress: 'Suprimir', arguments: 'Argumentos', presentation: 'Apresentação' },
      presentationStates: { label: 'Estado da tecla', hint: 'Escolha a apresentação padrão ou personalize um estado.', default: 'Padrão', on: 'Ligado', off: 'Desligado', waiting: 'Aguardando', running: 'Executando', succeeded: 'Concluído', failed: 'Falhou', denied: 'Negado', cancelled: 'Cancelado', timed_out: 'Expirou', outcome_unknown: 'Resultado desconhecido', inheritance: 'Campos sem substituição usam a apresentação padrão.', inherit: 'Herdar padrão', unavailableIcon: 'Ícone não disponível' },
      presentation: { help: 'Personalize o título, o ícone e a imagem exibidos no Stream Deck. PNG/JPEG têm limite de 1 MiB, 4096×4096 e 4 milhões de pixels; o backend normaliza para 128×128. A imagem associada não viaja na exportação: em outra máquina ou proprietário, o fallback usa ícone e título e é preciso selecioná-la novamente.', fallback: 'Fallback somente do título: vazio usa o nome do comando localizado naquele idioma.', icon: { label: 'Ícone', hint: 'Ícones desconhecidos permanecem disponíveis para substituição ou remoção.', none: 'Sem ícone', settings: 'Configurações', chat: 'Conversa', folder: 'Pasta', play: 'Executar', stop: 'Parar', back: 'Voltar', star: 'Estrela', unavailable: 'Ícone não disponível: {{icon}}' }, image: { label: 'Imagem personalizada', hint: 'PNG/JPEG de até 1 MiB, no máximo 4096×4096 e 4 milhões de pixels. O backend normaliza para 128×128.', saved: 'Imagem personalizada associada.', selected: 'Imagem personalizada selecionada.', remove: 'Remover imagem personalizada', invalidFormat: 'Escolha um arquivo PNG ou JPEG.', tooLarge: 'A imagem deve ter no máximo 1 MiB.', readError: 'Não foi possível ler a imagem selecionada.', removed: 'Imagem personalizada removida.' }, locales: { ptBR: 'Português (Brasil)', en: 'English', es: 'Español' }, invalid: 'Revise os títulos personalizados antes de salvar.', invalidNul: 'O título não pode conter o caractere NUL.', invalidLength: 'O título deve ter no máximo 256 codepoints.' },
      statusExtra: { suppressed: 'Suprimido' }, argumentEditor: { key: 'Nome do argumento', invalid: 'Revise os nomes e os valores dos argumentos.', true: 'Verdadeiro', false: 'Falso' }, objectFields: { value: 'Valor', type: 'Tipo', add: 'Adicionar argumento', remove: 'Remover argumento {{index}}', types: { string: 'Texto', number: 'Número', boolean: 'Booleano', json: 'Objeto ou lista' } },
      form: { name: 'Nome', description: 'Descrição', priority: 'Prioridade', enabled: 'Habilitada', effect: 'Efeito', effects: { execute: 'Executar', suppress: 'Suprimir' }, arguments: 'Argumentos', presentation: 'Apresentação', source: 'Origem', command: 'Comando', chooseCommand: 'Escolha um comando', noShortcut: 'Nenhum atalho', noCommand: 'Comando indisponível', noStreamdeck: 'Stream Deck não configurado', captureButton: 'Gravar acionador', captureCancel: 'Cancelar gravação', captureStarting: 'Preparando captura…', captureWaiting: 'Pressione e solte a tecla desejada no Stream Deck.', captureInfo: 'Grave uma tecla do Stream Deck para associá-la ao comando.', captureExisting: 'Stream Deck — tecla {{key}}', captureResult: '{{model}} — tecla {{key}}', captureUnknownModel: 'Stream Deck', captureStatus: { starting: 'Preparando captura…', no_device: 'Nenhum Stream Deck disponível no momento.', unavailable: 'O Stream Deck está temporariamente indisponível.', cancelled: 'Gravação cancelada.', timeout: 'A gravação expirou.' }, paletteInfo: 'A seleção da paleta é derivada do comando escolhido.' }, dialog: { layerTitle: 'Camada de comandos', bindingTitle: 'Comando e acionador', ruleTitle: 'Regra de ativação' }, messages: { saved: 'Alteração de comandos salva.', committedNotPublished: 'Configuração salva, mas o mapa de comandos não foi atualizado. Não repita a gravação; recarregue para conferir.' }, errors: { generic: 'Não foi possível concluir a alteração de comandos.', load: 'Não foi possível carregar as configurações de comandos.' }, diagnostics: { title: 'Diagnósticos', severity: { info: 'Informação', warning: 'Aviso', error: 'Erro' }, codes: { unknown: 'O backend informou um diagnóstico de configuração.', invalid_condition: 'Este binding tem uma condição inválida e está indisponível.', unsupported_local_condition: 'Esta condição não é suportada para execução de teclado local e o binding está indisponível.', unsupported_contextual_binding: 'Este binding contextual não pode ser publicado para a superfície de execução selecionada.' } }, rules: { title: 'Regras de ativação', new: 'Nova regra', edit: 'Editar regra', delete: 'Excluir regra', mode: 'Modo', lifecycle: 'Ciclo de vida', eventGrantHelp: 'Regras de evento ficam desabilitadas durante a edição. Use o menu de ações para desabilitar ou reativar somente após confirmar a autorização do evento.', importedLifecycleHelp: 'Este ciclo de vida importado é exibido para inspeção. Esta tela não oferece controles de duração ou expiração.', modes: { manual: 'Manual', always: 'Sempre', condition: 'Condição', event: 'Evento' }, lifecycles: { persistent: 'Persistente', session: 'Sessão', temporary: 'Temporária' } }, conditionFields: { appFocused: 'Aplicativo em foco', appPage: 'Página do aplicativo', surfaceType: 'Tipo de superfície', profile: 'Perfil', process: 'Processo em primeiro plano' }, conditionValues: { chat: 'Chat', editor: 'Editor', history: 'Histórico', profiles: 'Perfis', tasklists: 'Listas de tarefas', terminal: 'Terminal', pageWorkspace: 'Área de trabalho', pageSettings: 'Configurações', pageProfiles: 'Perfis', pageHistory: 'Histórico', pageHelp: 'Ajuda', pageAbout: 'Sobre', pageUpdate: 'Atualizações', pageTasklists: 'Listas de tarefas', pageJobs: 'Tarefas', pageMemories: 'Memórias' }, conditions: { title: 'Condições', help: 'Todas as condições devem ser verdadeiras. Os campos são tipados e não aceitam expressões livres.', empty: 'Nenhuma condição; este binding funciona como curinga.', listLabel: 'Condições do binding', field: 'Campo', value: 'Valor', add: 'Adicionar condição', remove: 'Remover condição', opaqueHint: 'Valor opaco fornecido pelo contexto autorizado.' },
    },
    ...
    dataManagement: {
      ...
      commandInvocationRetentionDaysLabel: 'Retenção de auditoria de invocações (dias)',
      commandInvocationRetentionDaysDescription: 'Tempo de retenção da auditoria detalhada de invocações de comandos. Padrão: 30 dias.',
      commandInvocationsPerUserKeepLabel: 'Invocações mantidas por usuário',
      commandInvocationsPerUserKeepDescription: 'Quantidade máxima de auditorias terminais detalhadas mantidas por usuário. Padrão: 10.000.',
      commandInvocationsSystemKeepLabel: 'Invocações system mantidas',
      commandInvocationsSystemKeepDescription: 'Quantidade máxima de auditorias terminais detalhadas internas mantidas sem usuário. Padrão: 1.000.',
      commandActivationTerminalRetentionDaysLabel: 'Retenção de ativações terminais (dias)',
      commandActivationTerminalRetentionDaysDescription: 'Tempo de retenção da auditoria e do estado terminal das ativações. A barreira de replay do ledger é protegida; estados ativos não são removidos. Padrão: 30 dias.',
      commandActivationTerminalKeepPerUserLabel: 'Ativações terminais mantidas por usuário',
      commandActivationTerminalKeepPerUserDescription: 'Quantidade máxima de ativações terminais mantidas por usuário. Padrão: 10.000.',
      commandJobActivationLeaseSecondsLabel: 'Lease de ativação de job (segundos)',
      commandJobActivationLeaseSecondsDescription: 'Validade da claim de ativação de job, renovada pelo heartbeat do runtime; não é tempo de processamento do outbox. Padrão: 180 segundos.',
    ...
    commandImport: {
      title: 'Importar camadas de comandos',
      description: 'Este arquivo contém somente camadas de comandos. Revise a política e os destinos antes da confirmação.',
      fileLabel: 'Arquivo',
      layerCountLabel: 'Camadas',
      policyLabel: 'Política de conflito',
      policyDescription: 'A política é obrigatória e não possui uma opção destrutiva pré-selecionada.',
      policyPlaceholder: 'Selecione uma política',
      policyRequired: 'Selecione uma política de conflito antes de importar.',
      policyKeep: 'Manter',
      policyReplace: 'Substituir',
      policyCopy: 'Copiar como nova camada',
      notSelected: 'Não selecionada',
      copyNamesTitle: 'Nomes de destino',
      copyNamesDescription: 'Informe um nome de destino quando a importação precisar evitar conflito de nome. Os campos são opcionais; a validação final é do backend.',
      copyNameLabel: 'Nome para {{name}}',
      copyNamePlaceholder: 'Nome opcional',
      workspaceTitle: 'Destinos de workspace',
      workspaceDescription: 'Cada workspace de origem precisa de um destino explícito autorizado pela aplicação.',
      workspaceLoading: 'Carregando destinos...',
      workspacePlaceholder: 'Selecione um destino',
      workspaceDestinationLabel: 'Destino para {{sourceId}}',
      workspaceMappingRequired: 'Selecione um workspace de destino para cada workspace de origem.',
      workspaceListError: 'Não foi possível carregar os workspaces de destino{{reason}}.',
      noWorkspaceDestination: 'Nenhum workspace de destino autorizado está disponível.',
      mixedResources: 'Arquivos de camadas de comandos não podem misturar outros recursos. Selecione um arquivo somente de commandLayers.',
      invalidFile: 'O arquivo de camadas de comandos não é um JSON válido.',
      fileTooLarge: 'O arquivo excede o limite de {{limit}} KiB para camadas de comandos.',
      pending: 'Importação de camadas de comandos pendente de confirmação.',
      pendingHint: 'Aguardando a confirmação do backend. Não envie novamente enquanto esta operação estiver pendente.',
      apply: 'Aplicar importação',
      changeFile: 'Trocar arquivo',
      success: 'Camadas de comandos importadas.',
      partial: 'A importação das camadas de comandos não foi concluída integralmente.',
      counts: 'Importadas: {{imported}}. Ignoradas: {{skipped}}. Falhas: {{failed}}.',
      error: 'Não foi possível importar as camadas de comandos{{reason}}.',
      reportTitle: 'Relatório da importação',
      reportSuccess: 'Concluído',
      reportFailure: 'Não concluído',
      reportLocked: 'Este arquivo não pode ser aplicado novamente. Troque o arquivo para iniciar outra importação.',
      errorsLabel: 'Erros',
    ...
    commandExport: {
      empty: 'Não há camadas ou personalizações para exportar neste escopo.',
      limit: 'A exportação excede o limite de 64 entradas ou 64 KiB. Nenhum arquivo foi gerado.',
      title: 'Exportar camadas de comandos',
      description: 'Exporte somente commandLayers, sem credenciais, grants ou claims.',
      scopeTitle: 'Escopo da exportação',
      scopeDescription: 'O escopo global é incluído por padrão. Você pode incluir também os workspaces aos quais tem acesso.',
      includeWorkspace: 'Incluir workspaces acessíveis',
      export: 'Exportar camadas de comandos',
      filenamePrefix: 'camadas-comandos',
      success: 'Camadas de comandos exportadas com sucesso.',
      error: 'Não foi possível exportar as camadas de comandos.',
    },
    portability: {
      messages: {
        import: {
        ...
        commandImport: {
          committedNotPublished: 'A importação foi gravada, mas o mapa de comandos não foi publicado. Não importe este arquivo novamente; troque o arquivo antes de tentar outra importação.',
          layerResult: 'Camada {{targetId}}: {{action}} (escopo {{scope}}).',
    ...
    editor: {
      ...
      richLink: {
        ...
        descEdit: 'Informe o novo endereço do link. O texto será preservado.',
      ...
      insertCommands: {
        ...
        rows: '{{count}} linhas',
        cols: '{{count}} colunas',
        headerOn: 'Com cabeçalho',
        headerOff: 'Sem cabeçalho',
        markdown: 'Inserir (Markdown)',
        lists: 'Listas',
        bullets: 'Marcadores',
        numbers: 'Numerada',
        quote: 'Citação',
      ...
      commandTable: {
        ...
        description: 'Escolha o tamanho da tabela e se a primeira linha será um cabeçalho.',
        markdownDescription: 'Escolha o tamanho da tabela. No Markdown, a primeira linha é sempre o cabeçalho.',
        rows: 'Linhas',
        cols: 'Colunas',
        withHeaderRow: 'Usar primeira linha como cabeçalho',
        submit: 'Inserir tabela',
        cancel: 'Cancelar',
        invalid: 'Os dados da tabela são inválidos.',
      },
      questionnaire: {
      ...
      modePersistenceFailed: 'Não foi possível salvar o modo de exibição desta aba.',
    ...
    skills: {
      ...
      deleteCancelled: 'Exclusão cancelada',
      nameRequired: 'Nome é obrigatório',
      versionInvalid: 'Versão deve seguir o formato semântico X.Y.Z',
      ...
      generalSection: {
        ...
        versionHint: 'Use versionamento semântico no formato X.Y.Z.',
        description: 'Descrição',
    ...
    providers: {
      ...
      toast: {
        ...
        agentUpdated: 'Agente de "{{name}}" atualizado para a versão {{version}}.',
      },
      error: {
        loadFailed: 'Erro ao carregar provedores',
        duplicateFailed: 'Erro ao duplicar provedor',
        deleteFailed: 'Erro ao remover provedor',
        updateAgentFailed: 'Não foi possível atualizar o agente: {{reason}}',
        updateAgentFailedUnknown: 'erro desconhecido',
    ...
    ui: {
      ...
      shortcuts: {
        ...
        unavailable: 'Sem atalho efetivo disponível',
        componentGesture: 'Gesto do componente',
        nativeGesturesNote: 'Gestos nativos são exibidos apenas como referência e não são bindings de comandos configuráveis.',
      },
    },
        ...
        chat: {
          ...
          blocks: [
            ...
            { type: 'ul', items: [
              ...
              '**Perfil de interação:** Ctrl+P',
              '**Limpar conversa:** Ctrl+L',
            ] },
          ],
        },
        voice: {
        ...
        keyboard: {
          ...
          blocks: [
            ...
            { type: 'table', headers: ['Atalho', 'Ação'], rows: [
              ...
              ['[[Ctrl]]+[[P]]', 'Seletor de perfil de interação'],
    ...
    history: {
      ...
      deleteSucceeded: '{{count}} conversa(s) excluída(s).',
      deletePartial: '{{successCount}} conversa(s) excluída(s); falha ao excluir {{failureCount}}.',
      deleteFailed: 'Não foi possível excluir {{count}} conversa(s).',
    ...
    workspace: {
      ...
      announce: {
        ...
        workspaceCreatedCommand: 'Workspace criado',
    ...
    jobs: {
      ...
      builder: {
        ...
        authorizedProfilesTitle: 'Perfis autorizados para este job',
        authorizedProfilesDynamicDescription: 'O valor do template nunca é autorizado automaticamente. Escolha e autorize cada perfil que este job poderá usar.',
        authorizedProfilesLiteralDescription: 'Este job só poderá executar sozinho com o perfil configurado depois de uma autorização explícita.',
        noAuthorizedProfiles: 'Nenhum perfil autorizado.',
        chooseProfileToAuthorize: 'Perfil a autorizar',
        chooseProfilePlaceholder: 'Selecione um perfil',
        authorizeProfile: 'Autorizar perfil',
        revokeProfile: 'Revogar',
        profileInputRequired: 'Preencha o input profile para autorizar a delegação.',
        saveBeforeAuthorizingProfiles: 'Salve o job antes de autorizar perfis.',
        saveProfileConfigurationFirst: 'Salve a configuração atual do profile antes de autorizar ou revogar acessos.',
        profileAuthorized: 'Perfil {{profile}} autorizado para este job.',
        profileAuthorizationDenied: 'Autorização recusada. O job continua sem essa permissão.',
        profileGrantNotAuthorizedError: 'Este job não tem autorização para usar o profile selecionado.',
        profileGrantUnavailableError: 'Não foi possível atualizar a autorização do profile. Tente novamente.',
        revokeProfileAriaLabel: 'Revogar autorização do profile {{profile}}',
        profileRevoked: 'Autorização do perfil {{profile}} revogada.',
        savedDisabledWithoutAuthorization: 'O job foi salvo desativado porque a autorização não foi concedida.',
        savedDisabledChooseProfiles: 'O job foi salvo desativado. Autorize ao menos um perfil para o template antes de ativá-lo.',
        enableRequiresAuthorizedProfile: 'Autorize um perfil para este job antes de ativá-lo.',
      },
    },
    tasklist: {
      ...
      changeStatus: 'Alterar status: {{status}}',
      ...
      createNewHintGeneric: 'Clique em "Nova Lista" acima',
      ...
      pagination: {
        ...
        boardProgress: '{{loaded}} de {{total}} cards carregados; o quadro já está navegável',
        boardLoaded: 'Quadro completo com {{count}} cards',
        boardLoadFailed: 'Não foi possível carregar todos os cards. Os cards disponíveis continuam navegáveis.',
        retryBoard: 'Tentar carregar cards restantes',
      },
      ...
      workflow: {
        ...
        statusInUseMigrate: 'O status "{{label}}" tem {{count}} tarefa(s). Escolha para qual status movê-las antes de remover.',
        removeAndMigrate: 'Remover e migrar',
      ...
      customActions: {
        ...
        hint: 'Defina ações por card ou quadro. Cada ação pode publicar um evento (que pode disparar jobs) e/ou abrir um link. Os templates têm acesso aos campos do card (.task.code, .task.link, etc.). As alterações são salvas automaticamente.',
        ...
        toolbar: 'Barra de ferramentas de ações customizadas',
        grid: 'Lista de ações customizadas',
        added: 'Ação adicionada',
        updated: 'Ação atualizada',
        deleted: 'Ação apagada',
    ...
    app: {
      ...
      questionnaire: {
        ...
        jobProfileGrant: {
          title: 'Autorizar profile para este job?',
          description: 'O job {{jobName}} poderá executar sozinho usando somente o profile {{targetProfile}} enquanto essa configuração não mudar.',
        ...
        editConfirmation: {
          ...
          overwriteTitle: 'Confirmar sobrescrita',
          overwriteDescription: 'O arquivo "{{path}}" já existe. Deseja sobrescrevê-lo?',
          overwriteConfirm: 'Sobrescrever',
