  ...
  translation: {
    ...
    channels: {
      ...
      sip: {
        ...
        denoise: 'Redução de ruído (denoise)',
        agc: 'Controle automático de ganho (AGC)',
        noiseSuppressDb: 'Supressão de ruído (dB)',
        noiseSuppressDbHint: 'Quanto mais negativo, mais agressiva a limpeza. Valor padrão recomendado: -24 dB.',
        agcTarget: 'Alvo do AGC',
        agcMaxGainDb: 'Ganho máximo do AGC (dB)',
        agcHint: 'Ajuste o volume do áudio capturado antes do STT. Alvo mais alto deixa a fala mais forte; ganho máximo limita compensações excessivas.',
        vadMode: 'Modo do VAD (0-3)',
        vadSpeechMs: 'Mínimo de fala (ms)',
        vadSilenceMs: 'Silêncio para encerrar (ms)',
        vadHint: 'O VAD WebRTC fica mais agressivo em valores altos. O silêncio controla quanto tempo esperar antes de fechar o segmento.',
        bargeInThreshold: 'Limiar de barge-in',
        bargeInThresholdHint: 'RMS mínimo para interromper TTS quando a pessoa fala por cima. Faixa típica: 0.10 a 0.20.',
        maxContacts: 'Máximo de Contatos',
