const ptBR = {
  translation: {
    ...
    commandSettings: {
      ...
      presentation: { help: 'Personalize o título exibido no Stream Deck por idioma. Deixe vazio para usar o nome do comando localizado naquele idioma.', fallback: 'Vazio: usa o nome do comando localizado naquele idioma.', locales: { ptBR: 'Português (Brasil)', en: 'English', es: 'Español' }, invalid: 'Revise os títulos personalizados antes de salvar.', invalidNul: 'O título não pode conter o caractere NUL.', invalidLength: 'O título deve ter no máximo 256 codepoints.' },
