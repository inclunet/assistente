const ptBR = {
  translation: {
    ...
    profiles: {
      ...
      nativeMcpHint: "Como os servidores MCP são entregues ao provider. O modo nativo usa o formato do provider (OpenAI Responses → type:mcp; Anthropic → mcp_servers). Automático = modo adapter (function) por padrão, compatível com qualquer modelo. 'Forçar nativo' só tem efeito em providers fisicamente capazes (Responses/Anthropic).",
    ...
    subagents: {
      pageTitle: 'Sub-agentes',
      loading: 'Carregando sub-agentes...',
      empty: 'Nenhum sub-agente ainda. Eles aparecem aqui quando o assistente delega tarefas em sub-conversas próprias.',
      search: 'Buscar sub-agentes...',
      refresh: 'Atualizar',
      ...
      colTokens: 'Tokens (custo)',
      colUpdated: 'Atualizada em',
      colActions: 'Ações',
      actions: 'Ações',
      status: {
        queued: 'Na fila',
