const ptBR = {
  translation: {
    ...
    pickers: {
      ...
      voiceProvider: { label: 'Provedor de Voz', description: 'Selecione o provedor de síntese', loading: 'Carregando provedores...', loadError: 'Erro ao carregar provedores', screenReader: 'Leitor de telas (desativar TTS)', screenReaderDesc: 'Usa o leitor de telas e desativa a síntese de voz', default: 'Padrão (Assistente)', defaultDesc: 'Usa o provedor do Assistente', webspeech: 'WebSpeech (Navegador)', webspeechDesc: 'Vozes do navegador (grátis)', sapi5: 'SAPI5 (Windows)', sapi5Desc: 'Vozes do Windows', followAssistant: 'Seguir voz do Assistente', followAssistantDesc: 'Usa a mesma voz do Assistente', followUser: 'Seguir voz do Usuário', followUserDesc: 'Usa a mesma voz do Usuário', followSystem: 'Seguir voz do Sistema', followSystemDesc: 'Usa a mesma voz do Sistema', llmProvider: 'Provedor LLM' },
