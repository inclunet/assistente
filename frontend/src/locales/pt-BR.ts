const ptBR = {
  translation: {
    ...
    skills: {
      ...
      noSkillsDb: 'Nenhum skill encontrado. Use o botão "Novo Skill" para criar um.',
      ...
      generalSection: {
        ...
        auto: 'Permitir que o modelo invoque este skill automaticamente',
      },
      contentSection: {
        title: 'Conteúdo',
      ...
      catalogSection: {
        ...
        autoLoad: 'Auto-load — injetar automaticamente no system prompt',
