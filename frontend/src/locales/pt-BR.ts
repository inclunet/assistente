const ptBR = {
  translation: {
    ...
    chat: {
      ...
      toolbarLabel: 'Ferramentas do chat. Use setas para navegar entre os botões',
      newBtn: 'Nova',
      clearBtn: 'Limpar',
      historyBtn: 'Histórico, Ctrl+H',
    ...
    editor: {
      ...
      inlineChat: {
        ...
        conversationCleared: 'Conversa limpa',
        clearError: 'Erro ao limpar conversa',
        toolbarLabel: 'Ferramentas do mini-chat. Use setas para navegar entre os botões',
        newBtn: 'Nova',
        clearBtn: 'Limpar',
        contextBtn: 'Contexto',
    ...
    landmarks: {
      ...
      content: 'Conteúdo',
      workspaceToolbar: 'Barra de ferramentas do workspace',
      workspaceTabs: 'Abas do workspace',
    },
    workspace: {
      toolbarLabel: 'Barra de ferramentas do workspace',
      ...
      profileLabel: 'Perfil do workspace',
      profileChanged: 'Perfil do workspace alterado',
      tabProfileLabel: 'Perfil da aba',
      tabSingular: 'aba',
      tabPlural: 'abas',
      tabCreated: 'Aba criada',
      renamed: 'Workspace renomeado',
      tabsRegion: 'Abas do workspace',
    ...
    tasklist: {
      ...
      // Resources menu
      resources: 'Recursos',
      resourcesMenu: 'Menu de recursos da conversa',
      linkedTaskLists: 'Task Lists',
      noLinkedTaskLists: 'Nenhuma lista vinculada',
      linkTaskList: 'Vincular lista...',
      unlinkTaskList: 'Desvincular',
      viewTaskList: 'Visualizar',
      selectTaskList: 'Selecionar Lista de Tarefas',
      selectTaskListHint: 'Escolha uma lista para vincular a esta conversa',
      linked: 'Vinculada',
      linkedSuccess: 'Lista vinculada com sucesso',
      unlinkedSuccess: 'Lista desvinculada com sucesso',
      viewLinkedTaskList: 'Visualizar lista vinculada',
