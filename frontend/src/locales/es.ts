const es = {
  translation: {
    ...
    tasklist: {
      ...
      // Resources menu
      resources: 'Recursos',
      resourcesMenu: 'Menú de recursos de la conversación',
      linkedTaskLists: 'Listas de Tareas',
      noLinkedTaskLists: 'Ninguna lista vinculada',
      linkTaskList: 'Vincular lista...',
      unlinkTaskList: 'Desvincular',
      viewTaskList: 'Visualizar',
      selectTaskList: 'Seleccionar Lista de Tareas',
      selectTaskListHint: 'Elige una lista para vincular a esta conversación',
      linked: 'Vinculada',
      linkedSuccess: 'Lista vinculada exitosamente',
      unlinkedSuccess: 'Lista desvinculada exitosamente',
      viewLinkedTaskList: 'Ver lista de tareas vinculada',
