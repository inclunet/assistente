const en = {
  translation: {
    ...
    commandSettings: {
      ...
      formExtra: { effect: 'Effect', execute: 'Execute', suppress: 'Suppress', arguments: 'Arguments', presentation: 'Presentation' }, presentation: { help: 'Customize the title shown on Stream Deck by language. Leave it empty to use the command name localized in that language.', fallback: 'Empty: uses the command name localized in that language.', locales: { ptBR: 'Português (Brasil)', en: 'English', es: 'Español' }, invalid: 'Review the custom titles before saving.', invalidNul: 'The title cannot contain the NUL character.', invalidLength: 'The title must be at most 256 codepoints.' }, scope: { label: 'Scope', global: 'Global', workspace: 'Current workspace' }, priority: 'Layer priority: {{value}}',
