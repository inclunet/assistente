const en = {
  translation: {
    ...
    commandPalette: {
      ...
      executionFailed: 'Could not execute the command.',
      executionSucceeded: 'Command executed.',
      executionCancelled: 'Command execution was cancelled.',
      executionUnknown: 'Could not confirm command execution.',
      executionSuppressed: 'This activation is disabled in the command configuration.',
      ...
      arguments: {
        title: 'Arguments for {{command}}',
        description: 'Enter the arguments accepted by this command. They are sent only for this execution.',
        submit: 'Run',
        invalid: 'Enter a valid value for this argument.',
        unsupported: 'This command declares arguments in a format the palette cannot edit.',
        chooseRequired: 'Choose a value',
        skip: 'Do not provide',
        null: 'Null value',
        provideValue: 'Provide a value',
        value: 'Value',
        jsonHint: 'Enter a JSON value.',
        toolSchemaTitle: 'Parameters for {{tool}}',
        toolSchemaLabel: 'Tool JSON schema',
        toolSchemaHint: 'Use this schema as a reference when filling arguments_json. The backend validates and confirms execution.',
        toolSchemaUnavailable: 'The tool schema could not be loaded. The backend will still validate execution.',
      },
    },
    ...
    commandShortcutCapture: {
      ...
      simple: 'Single combination',
      sequence: 'Two-step sequence',
      sequenceHint: 'Record a combination with Control, Alt or Meta, release the keys, then press a key without modifiers. The selected type applies to the next recording.',
      sequenceStarted: 'Sequence recording started. Press the first combination with Control, Alt or Meta.',
      nextStep: 'First step: {{shortcut}}. Release the keys and press the second key without modifiers.',
      finalCapturing: 'Press the second key…',
      prefixInvalid: 'The first step requires Control, Alt or Meta.',
      releaseFirst: 'Release the first combination before pressing the second key without modifiers.',
      buttonLabel: 'Capture keyboard shortcut',
      empty: 'Set shortcut',
      capturing: 'Press a shortcut…',
      hint: 'Press Escape to cancel. Tab cancels and moves focus.',
      started: 'Shortcut capture started.',
      cancelled: 'Shortcut capture cancelled.',
      captured: 'Shortcut captured: {{shortcut}}.',
      invalid: 'That key combination cannot be used for a shortcut.',
    },
    ...
    chat: {
      ...
      system: 'System',
      reading: 'Reading',
      readingDialog: 'Reading message. Press Escape to exit.',
      readingOpen: 'Reading mode enabled. Press Escape to exit.',
      readingClose: 'Reading mode disabled.',
      sent: 'sent',
      received: 'received',
      via: 'Via',
      ...
      pins: {
        ...
        buttonDescription: 'List pinned messages in this conversation',
        title: 'Pinned messages',
        description: 'Messages pinned in this conversation, including thread and tool messages.',
        listLabel: 'Pinned messages in the conversation',
      ...
      slashMenuOpened_one: 'Command menu opened with {{count}} option',
      slashMenuOpened_other: 'Command menu opened with {{count}} options',
      slashMenuClosed: 'Command menu closed',
      slashActiveOption: '{{command}}, option {{position}} of {{total}}',
      slashItemSelected: '{{command}} selected',
      ...
      toolReadFileDone: 'Read file',
      toolEditFile: 'Editing file',
      toolEditFileDone: 'Edited file',
      toolListDirectory: 'Listing files',
      toolListDirectoryDone: 'Listed files',
      toolSearchFiles: 'Searching files',
      toolSearchFilesDone: 'Searched files',
      toolRunCommand: 'Running command',
      toolRunCommandDone: 'Ran command',
      toolSearchWeb: 'Searching the web',
      toolSearchWebDone: 'Searched the web',
      toolAccessUrl: 'Accessing site',
      toolAccessUrlDone: 'Accessed site',
      toolMcpProvider: 'Consulting {{provider}}',
      toolMcpIntegration: 'Consulting a connected integration',
      toolGeneric: 'Running tool',
      toolGenericDone: 'Used a tool',
      toolStatusRetrying: 'Retrying',
      partialOutput: 'Partial output',
      partialOutputAvailable: 'Receiving partial output',
      parameters: 'Parameters',
      response: 'Response',
      showLess: 'Show less',
      showAll: 'Show all',
      loadingToolDetails: 'Loading details...',
      toolDetailsUnavailable: 'Details for this execution are no longer available.',
      toolDetailsLoadError: 'Could not load the tool details.',
      viewSearchResults: 'View {{count}} result(s)',
    ...
    settingsPage: {
      ...
      tabs: {
        ...
        commands: 'Commands and triggers',
      },
    },
    ...
    commandSettings: {
      ...
      layerActionScope: 'Back scope',
      layerActionOriginHelp: 'Uses an existing manual rule. Back ends the latest activation from the same source; Stream Deck and keyboard histories are separate.',
      foregroundProcessHint: 'Executable name, for example obs64.exe. Do not enter a path, window title or URL. The condition uses the foreground program at the key press, before opening Assistente.',
      conditionDevice: 'Connected Stream Deck',
      conditionDeviceNumbered: '{{model}} — device {{index}}',
      advancedOptions: 'Advanced trigger options',
      toolExecution: { adHocOnly: 'Tool execution is ad hoc only; potentially sensitive arguments cannot be saved in a persistent trigger.' },
      conditionRowLabel: 'Condition {{index}}: {{field}}',
      unsupportedOriginCondition: 'This trigger or its layer requires a condition unavailable for this source. It will not execute.',
      unavailableCondition: 'Unavailable condition: {{field}}',
      unavailableConditionValue: 'Value unavailable in this context (preserved)',
      manualToggle: 'Toggle activation',
      manualActionTitle: 'Temporary activation', manualDurationSeconds: 'Duration (seconds)', manualDurationHint: 'Enter a value between 1 and 86400 seconds.', manualPin: 'Pin layer', manualDeactivate: 'Deactivate layer', manualBack: 'Back to last activation', manualActivation: 'Manual activation', manualActiveUntil: 'Active until {{date}}',
      tasklistSurface: 'Task list tab',
      keyboardAvailable: 'Alt navigation shortcuts are in the always-active Application keyboard defaults layer. Active personal layers can override them. List workspaces and navigation support Control, Alt or Meta combinations without contextual conditions or conflicts. Editable fields and modals take priority.',
      title: 'Commands and triggers', description: 'Manage command layers, the commands and triggers assigned to them, and their activation rules.', layers: 'Layers', commands: 'Commands in this layer', whenActive: 'When this layer is active', noLayer: 'Select a layer', builtinLayer: 'Built-in layer; its defaults can be restored.', keyboardUnavailable: 'Command keyboard input is currently unavailable. Shortcuts not yet migrated remain on the previous system.', prepareManual: 'Prepare manual activation', activateManual: 'Activate manually', deactivateManual: 'Deactivate manual activation', manualActivationHelp: 'Prepare creates a persistent rule after backend confirmation but does not activate it automatically. Activate applies eligible bindings. For keyboard input, see the operational limits shown on this page. Deactivate removes only activation from this source.',
      managers: { settings: 'Layer settings', commands: 'Commands and triggers', hint: 'Use layer settings to manage its commands and activation rules.', commandsCount: 'Triggers: {{count}}', rulesCount: 'Activation rules: {{count}}' },
      columns: { name: 'Name', description: 'Description', state: 'State', command: 'Command', trigger: 'Trigger', binding: 'Binding', review: 'Review' }, states: { active: 'Active', inactive: 'Inactive', notEvaluated: 'Not evaluated', enabled: 'Enabled', disabled: 'Disabled', readOnly: 'Read-only', needsReview: 'Needs review' }, sources: { keyboard: 'Local keyboard', streamdeck: 'Stream Deck', palette: 'Palette' }, deck: { status: 'Stream Deck: {{status}} ({{count}} device(s) reported by the runtime).', statuses: { connected: 'connected', reconnecting: 'reconnecting', degraded: 'degraded', disconnected: 'disconnected', unavailable: 'unavailable', unconfigured: 'not configured', unknown: 'unknown state' }, devices: { title: 'Stream Deck devices', keyCount: '{{count}} keys' }, reasons: { openFailed: 'Could not open this device.', reconnectBackoff: 'A retry is waiting for the reconnect backoff interval.' } },
      actions: { newLayer: 'New layer', newBinding: 'New binding', editLayer: 'Edit layer', editBinding: 'Edit binding', deleteLayer: 'Delete layer', deleteBinding: 'Delete binding', restore: 'Restore default', restoreAll: 'Restore configuration', restoreLayer: 'Restore layer', rebaseDefault: 'Rebase default', upgradeDefaults: 'Upgrade defaults', suppress: 'Suppress default', toggleLayer: 'Toggle layer', enable: 'Enable', disable: 'Disable', reload: 'Reload' },
      formExtra: { effect: 'Effect', execute: 'Execute', suppress: 'Suppress', arguments: 'Arguments', presentation: 'Presentation' }, presentation: { help: 'Customize the title, icon, and image shown on Stream Deck. PNG/JPEG images are limited to 1 MiB, 4096×4096, and 4 million pixels; the backend normalizes them to 128×128. The associated image is not included in exports: on another machine or owner, the icon and title are the fallback and the image must be selected again.', fallback: 'Title-only fallback: empty uses the command name localized in that language.', icon: { label: 'Icon', hint: 'Unknown icons remain available for replacement or removal.', none: 'No icon', settings: 'Settings', chat: 'Chat', folder: 'Folder', play: 'Play', stop: 'Stop', back: 'Back', star: 'Star', unavailable: 'Icon unavailable: {{icon}}' }, image: { label: 'Custom image', hint: 'PNG/JPEG up to 1 MiB, at most 4096×4096 and 4 million pixels. The backend normalizes it to 128×128.', saved: 'Custom image associated.', selected: 'Custom image selected.', remove: 'Remove custom image', invalidFormat: 'Choose a PNG or JPEG file.', tooLarge: 'The image must be at most 1 MiB.', readError: 'The selected image could not be read.', removed: 'Custom image removed.' }, locales: { ptBR: 'Português (Brasil)', en: 'English', es: 'Español' }, invalid: 'Review the custom titles before saving.', invalidNul: 'The title cannot contain the NUL character.', invalidLength: 'The title must be at most 256 codepoints.' }, scope: { label: 'Scope', global: 'Global', workspace: 'Current workspace' }, priority: 'Layer priority: {{value}}',
      statusExtra: { suppressed: 'Suppressed' }, argumentEditor: { key: 'Argument name', invalid: 'Review argument names and values.', true: 'True', false: 'False' }, objectFields: { value: 'Value', type: 'Type', add: 'Add argument', remove: 'Remove argument {{index}}', types: { string: 'Text', number: 'Number', boolean: 'Boolean', json: 'Object or array' } },
      form: { name: 'Name', description: 'Description', priority: 'Priority', enabled: 'Enabled', source: 'Source', command: 'Command', chooseCommand: 'Choose a command', noShortcut: 'No shortcut', noCommand: 'Command unavailable', noStreamdeck: 'Stream Deck not configured', captureButton: 'Record trigger', captureCancel: 'Cancel recording', captureStarting: 'Preparing capture…', captureWaiting: 'Press and release the desired key on the Stream Deck.', captureInfo: 'Record a Stream Deck key to bind it to this command.', captureExisting: 'Stream Deck — key {{key}}', captureResult: '{{model}} — key {{key}}', captureUnknownModel: 'Stream Deck', captureStatus: { starting: 'Preparing capture…', no_device: 'No Stream Deck is currently available.', unavailable: 'The Stream Deck is temporarily unavailable.', cancelled: 'Recording cancelled.', timeout: 'Recording timed out.' }, paletteInfo: 'Palette selection is derived from the chosen command.' }, dialog: { layerTitle: 'Command layer', bindingTitle: 'Command and trigger', ruleTitle: 'Activation rule' }, messages: { saved: 'Command change saved.', committedNotPublished: 'Configuration saved, but the command map was not updated. Do not repeat the save; reload to check.' }, errors: { generic: 'Could not complete the command change.', load: 'Could not load the command settings.' }, diagnostics: { title: 'Diagnostics', severity: { info: 'Information', warning: 'Warning', error: 'Error' }, codes: { unknown: 'The backend reported a configuration diagnostic.', invalid_condition: 'This binding has an invalid condition and is unavailable.', unsupported_local_condition: 'This condition is not supported for local keyboard execution and the binding is unavailable.', unsupported_contextual_binding: 'This contextual binding cannot be published for the selected execution surface.' } }, rules: { title: 'Activation rules', new: 'New rule', edit: 'Edit rule', delete: 'Delete rule', mode: 'Mode', lifecycle: 'Lifecycle', eventGrantHelp: 'Event rules are disabled while editing. Disable or re-enable them from the actions menu only after confirming the event grant.', importedLifecycleHelp: 'This imported lifecycle is shown for inspection. This UI does not provide duration or expiry controls.', modes: { manual: 'Manual', always: 'Always', condition: 'Condition', event: 'Event' }, lifecycles: { persistent: 'Persistent', session: 'Session', temporary: 'Temporary' } }, conditionFields: { appFocused: 'Application focused', appPage: 'Application page', surfaceType: 'Surface type', profile: 'Profile', process: 'Foreground process' }, conditionValues: { chat: 'Chat', editor: 'Editor', history: 'History', profiles: 'Profiles', tasklists: 'Task lists', terminal: 'Terminal', pageWorkspace: 'Workspace', pageSettings: 'Settings', pageProfiles: 'Profiles', pageHistory: 'History', pageHelp: 'Help', pageAbout: 'About', pageUpdate: 'Updates', pageTasklists: 'Task lists', pageJobs: 'Jobs', pageMemories: 'Memories' }, conditions: { title: 'Conditions', help: 'All conditions must be true. Fields are typed and do not accept free-form expressions.', empty: 'No conditions; this binding acts as a wildcard.', listLabel: 'Binding conditions', field: 'Field', value: 'Value', add: 'Add condition', remove: 'Remove condition', opaqueHint: 'Opaque value supplied by authorized context.' },
    },
    ...
    dataManagement: {
      ...
      commandInvocationRetentionDaysLabel: 'Invocation audit retention (days)',
      commandInvocationRetentionDaysDescription: 'How long detailed command invocation audits are retained. Default: 30 days.',
      commandInvocationsPerUserKeepLabel: 'Invocations kept per user',
      commandInvocationsPerUserKeepDescription: 'Maximum number of detailed terminal audits kept per user. Default: 10,000.',
      commandInvocationsSystemKeepLabel: 'System invocations kept',
      commandInvocationsSystemKeepDescription: 'Maximum number of detailed terminal internal audits kept without a user. Default: 1,000.',
      commandActivationTerminalRetentionDaysLabel: 'Terminal activation retention (days)',
      commandActivationTerminalRetentionDaysDescription: 'How long activation audit records and terminal state are retained. The ledger replay barrier is protected; active states are not removed. Default: 30 days.',
      commandActivationTerminalKeepPerUserLabel: 'Terminal activations kept per user',
      commandActivationTerminalKeepPerUserDescription: 'Maximum number of terminal activations kept per user. Default: 10,000.',
      commandJobActivationLeaseSecondsLabel: 'Job activation lease (seconds)',
      commandJobActivationLeaseSecondsDescription: 'Validity of a job-activation claim, renewed by the runtime heartbeat; it is not outbox processing time. Default: 180 seconds.',
    ...
    commandImport: {
      title: 'Import command layers',
      description: 'This file contains command layers only. Review the policy and destinations before confirmation.',
      fileLabel: 'File',
      layerCountLabel: 'Layers',
      policyLabel: 'Conflict policy',
      policyDescription: 'A policy is required and no destructive option is preselected.',
      policyPlaceholder: 'Select a policy',
      policyRequired: 'Select a conflict policy before importing.',
      policyKeep: 'Keep',
      policyReplace: 'Replace',
      policyCopy: 'Copy as a new layer',
      notSelected: 'Not selected',
      copyNamesTitle: 'Destination names',
      copyNamesDescription: 'Enter a destination name when the import needs to avoid a name conflict. Fields are optional; the backend performs final validation.',
      copyNameLabel: 'Name for {{name}}',
      copyNamePlaceholder: 'Optional name',
      workspaceTitle: 'Workspace destinations',
      workspaceDescription: 'Each source workspace needs an explicit destination authorized by the application.',
      workspaceLoading: 'Loading destinations...',
      workspacePlaceholder: 'Select a destination',
      workspaceDestinationLabel: 'Destination for {{sourceId}}',
      workspaceMappingRequired: 'Select a destination workspace for every source workspace.',
      workspaceListError: 'Could not load destination workspaces{{reason}}.',
      noWorkspaceDestination: 'No authorized destination workspace is available.',
      mixedResources: 'Command-layer files cannot mix other resources. Select a file containing commandLayers only.',
      invalidFile: 'The command-layer file is not valid JSON.',
      fileTooLarge: 'The file exceeds the {{limit}} KiB command-layer limit.',
      pending: 'Command-layer import is pending confirmation.',
      pendingHint: 'Waiting for backend confirmation. Do not submit again while this operation is pending.',
      apply: 'Apply import',
      changeFile: 'Change file',
      success: 'Command layers imported.',
      partial: 'The command-layer import was not fully completed.',
      counts: 'Imported: {{imported}}. Skipped: {{skipped}}. Failed: {{failed}}.',
      error: 'Could not import command layers{{reason}}.',
      reportTitle: 'Import report',
      reportSuccess: 'Complete',
      reportFailure: 'Not completed',
      reportLocked: 'This file cannot be applied again. Change the file to start another import.',
      errorsLabel: 'Errors',
    ...
    commandExport: {
      empty: 'There are no layers or customizations to export in this scope.',
      limit: 'The export exceeds the limit of 64 entries or 64 KiB. No file was generated.',
      title: 'Export command layers',
      description: 'Export commandLayers only, without credentials, grants, or claims.',
      scopeTitle: 'Export scope',
      scopeDescription: 'The global scope is included by default. You can also include workspaces you can access.',
      includeWorkspace: 'Include accessible workspaces',
      export: 'Export command layers',
      filenamePrefix: 'command-layers',
      success: 'Command layers exported successfully.',
      error: 'Could not export command layers.',
    },
    portability: {
      messages: {
        import: {
        ...
        commandImport: {
          committedNotPublished: 'The import was saved, but the command map was not published. Do not import this file again; change the file before trying another import.',
          layerResult: 'Layer {{targetId}}: {{action}} (scope {{scope}}).',
          warning: 'Command warning {{code}}: {{count}}.',
        },
        conversation: {
    ...
    editor: {
      toast: {
        ...
        documentReadOnly: 'This document is rendered for reading only and cannot be saved by the editor.',
      ...
      documentView: {
        readOnlyBanner: 'Read-only view · {{format}} · rendered content',
        openedAnnouncement: '{{format}} document opened in read-only view.',
        pages: '{{count}} page(s)',
        noExtractableText: 'No extractable text was found. OCR is unavailable; this document may be a scanned image.',
        partialExtraction: 'Extraction was partial; some document content may have been omitted.',
      ...
      richLink: {
        titleEdit: 'Edit link',
        descEdit: 'Enter the new link address. The text will be preserved.',
      ...
      insertCommands: {
        ...
        rows: '{{count}} rows',
        cols: '{{count}} columns',
        headerOn: 'With header',
        headerOff: 'Without header',
      ...
      commandTable: {
        title: 'Insert table',
        description: 'Choose the table size and whether the first row is a header.',
        markdownDescription: 'Choose the table size. In Markdown, the first row is always the header.',
        rows: 'Rows',
        cols: 'Columns',
        withHeaderRow: 'Use first row as header',
        submit: 'Insert table',
        cancel: 'Cancel',
        invalid: 'The table data is invalid.',
      },
      questionnaire: {
      ...
      dialog: {
        ...
        filterDocuments: 'Documents and text',
        filterAll: 'All files',
      ...
      presentation: {
        ...
        mermaidErrorLabel: 'Mermaid diagram with an error',
        mermaidRenderError: 'Error rendering Mermaid',
        mermaidRenderErrorMessage: 'This diagram could not be displayed. The rest of the content remains available.',
        mermaidErrorDetails: 'Show technical details',
        mermaidUnknownError: 'Unknown error',
        mermaidTruncatedError: '… (error truncated; {{count}} characters)',
        mermaidCopyCode: 'Copy code',
        mermaidCopyError: 'Copy error',
        mermaidRerender: 'Render again',
        mermaidViewDiagram: 'View diagram',
        mermaidViewCode: 'View code',
        mermaidHideEditor: 'Hide editor',
        mermaidOpenEditor: 'Open in editor',
        mermaidActionsLabel: 'Mermaid actions',
        mermaidErrorActionsLabel: 'Mermaid error actions',
    ...
    terminal: {
      ...
      buttons: { stop: 'Interrupt', new: 'New terminal', terminate: 'Terminate terminal' },
      placeholders: { creating: 'Select or create a terminal', command: 'Type a command... (Ctrl+C to interrupt)' },
      states: { idle: 'idle', busy: 'running', running: 'running', closing: 'closing', closed: 'closed', exited: 'exited' },
      picker: {
        label: 'Connected terminal',
        description: 'Choose which terminal session this tab displays',
        placeholder: 'Search terminals...',
        empty: 'No live terminals',
      ...
      announce: {
        ...
        emptyOutput: 'empty',
        selected: 'Terminal selected: {{name}}',
        created: 'New terminal created and connected',
        createFailed: 'Could not create terminal',
        terminated: 'Terminal terminated',
        terminateFailed: 'Could not terminate terminal',
      },
      chatModal: {
    ...
    profiles: {
      ...
      chatSection: {
        ...
        groupRateLimit: 'Local Call Limit',
        groupPromptCache: 'Prompt Cache',
        rateLimitEnabled: 'Limit provider calls for this profile',
        rateLimitEnabledHint: 'Each model response, tool iteration, and summarization consumes one call. Disable it for long tasks if the provider already controls its own quota.',
        rateLimitRpm: 'Requests per minute',
        rateLimitRpmHint: 'Maximum sustained rate of LLM calls for this profile. Use 0 for the default of 60.',
        rateLimitBurst: 'Maximum burst',
        rateLimitBurstHint: 'Consecutive calls allowed before waiting. Use 0 for the default of 30. For agentic tasks, use at least the expected number of iterations.',
      ...
      toolPolicyDefaultLabel: 'Default state for new tools',
      toolPolicyDefaultLegacy: 'Legacy profile compatibility',
      toolPolicyDefaultDisabled: 'Disabled',
      toolPolicyDefaultOnDemand: 'On demand',
      toolPolicyDefaultHint: 'Sets the state of future tools and integrations not explicitly listed. Opt-in tools remain blocked.',
    ...
    skills: {
      ...
      nameRequired: 'Name is required',
      versionInvalid: 'Version must use the X.Y.Z semantic format',
      ...
      generalSection: {
        ...
        versionHint: 'Use semantic versioning in X.Y.Z format.',
        description: 'Description',
    ...
    providerForm: {
      ...
      reasoningContentMode: 'reasoning_content compatibility',
      reasoningContentModeHelp: 'Enable only when the endpoint protocol requires reasoning_content to be returned during tool calls. This decision does not depend on the provider URL or brand.',
      reasoningContentDisabled: 'Disabled',
      reasoningContentReplayWithTools: 'Replay during tool calls',
      baseUrl: 'Base URL',
    ...
    providers: {
      ...
      toast: {
        ...
        agentUpdated: 'Agent for "{{name}}" updated to version {{version}}.',
      },
      error: {
        loadFailed: 'Error loading providers',
        duplicateFailed: 'Error duplicating provider',
        deleteFailed: 'Error removing provider',
        updateAgentFailed: 'The agent could not be updated: {{reason}}',
        updateAgentFailedUnknown: 'unknown error',
    ...
    ui: {
      ...
      shortcuts: {
        ...
        goToWorkspace: 'Go back to workspace',
        goToSettings: 'Open settings',
        goToHistory: 'Open history',
        goToMemories: 'Open memories',
        ...
        unavailable: 'No effective shortcut available',
        componentGesture: 'Component gesture',
        nativeGesturesNote: 'Native gestures are shown for reference and are not configurable command bindings.',
      },
    },
        ...
        keyboard: {
          ...
          blocks: [
            ...
            { type: 'table', headers: ['Shortcut', 'Action'], rows: [
              ...
              ['[[Alt]]+[[W]] or [[Alt]]+[[Backspace]]', 'Go back to workspace'],
              ['[[Alt]]+[[C]]', 'Open settings'],
              ['[[Alt]]+[[H]]', 'Open history'],
              ['[[Alt]]+[[L]]', 'Open memories'],
              ['[[Alt]]+[[T]]', 'Open task lists'],
              ['[[Alt]]+[[J]]', 'Open jobs'],
              ['[[Alt]]+[[P]]', 'Open interaction profiles'],
            ...
            { type: 'table', headers: ['Shortcut', 'Action'], rows: [
              ...
              ['[[Ctrl]]+[[P]]', 'Interaction profile selector'],
    ...
    history: {
      ...
      deleteSucceeded: '{{count}} conversation(s) deleted.',
      deletePartial: '{{successCount}} conversation(s) deleted; {{failureCount}} could not be deleted.',
      deleteFailed: 'Could not delete {{count}} conversation(s).',
    ...
    subAgentRuns: {
      title: 'Sub-agent runs',
      open: 'Sub-agent runs',
      openWithCount: 'Sub-agent runs ({{count}} running)',
      gridLabel: 'Sub-agent runs',
      ...
      modeInline: 'Inline',
      cancel: 'Cancel run',
      cancelRunLabel: 'Cancel run {{title}}',
      announce: {
        started: 'Sub-agent started in the background: {{title}}',
        finished: {
          succeeded: 'Sub-agent finished: {{title}}',
          failed: 'Sub-agent failed: {{title}}',
          cancelled: 'Sub-agent cancelled: {{title}}',
          timed_out: 'Sub-agent timed out: {{title}}',
          unknown: 'Sub-agent ended: {{title}}',
        },
        cancelled: 'Run cancelled: {{title}}',
        cancelNoop: 'Run {{title}} had already finished. Status: {{status}}.',
        cancelError: 'Could not cancel run {{title}}',
      },
    },
    ...
    workspace: {
      ...
      announce: {
        ...
        workspaceCreatedCommand: 'Workspace created',
    ...
    jobs: {
      ...
      builder: {
        ...
        authorizedProfilesTitle: 'Profiles authorized for this job',
        authorizedProfilesDynamicDescription: 'The template value is never authorized automatically. Choose and authorize each profile this job may use.',
        authorizedProfilesLiteralDescription: 'This job may run unattended with the configured profile only after explicit authorization.',
        noAuthorizedProfiles: 'No authorized profiles.',
        chooseProfileToAuthorize: 'Profile to authorize',
        chooseProfilePlaceholder: 'Select a profile',
        ...
        profileGrantNotAuthorizedError: 'This job is not authorized to use the selected profile.',
        profileGrantUnavailableError: 'Could not update the profile authorization. Try again.',
        revokeProfileAriaLabel: 'Revoke authorization for profile {{profile}}',
        profileRevoked: 'Authorization for profile {{profile}} revoked.',
        savedDisabledWithoutAuthorization: 'The job was saved disabled because authorization was not granted.',
        savedDisabledChooseProfiles: 'The job was saved disabled. Authorize at least one profile for the template before enabling it.',
        enableRequiresAuthorizedProfile: 'Authorize a profile for this job before enabling it.',
      },
    },
    tasklist: {
      ...
      createNewHintGeneric: 'Click on "New List" above',
      ...
      pagination: {
        ...
        boardProgress: '{{loaded}} of {{total}} cards loaded; the board is already navigable',
        boardLoaded: 'Board complete with {{count}} cards',
        boardLoadFailed: 'Not all cards could be loaded. The available cards remain navigable.',
        retryBoard: 'Try loading remaining cards',
      },
      ...
      workflow: {
        ...
        statusInUseMigrate: 'Status "{{label}}" has {{count}} task(s). Choose which status to move them to before removing it.',
        removeAndMigrate: 'Remove and migrate',
      ...
      customActions: {
        ...
        hint: 'Define per-card or per-board actions. Each action can publish an event (which may trigger jobs) and/or open a link. Templates can read the card fields (.task.code, .task.link, etc.). Changes are saved automatically.',
        ...
        toolbar: 'Custom actions toolbar',
        grid: 'Custom actions list',
        added: 'Action added',
    ...
    app: {
      ...
      questionnaire: {
        ...
        jobProfileGrant: {
          title: 'Authorize a profile for this job?',
          description: 'Job {{jobName}} may run unattended using only profile {{targetProfile}} while this configuration remains unchanged.',
        ...
        commandInvocation: {
          ...
          description: 'A command invocation is ready to run. Execute it?',
          bodyLabel: 'Requested command',
          apply: 'Execute',
        },
        network: {
        ...
        editConfirmation: {
          ...
          overwriteDescription: 'The file "{{path}}" already exists. Do you want to overwrite it?',
