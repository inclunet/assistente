const en = {
  translation: {
    ...
    commandSettings: {
      ...
      formExtra: { effect: 'Effect', execute: 'Execute', suppress: 'Suppress', arguments: 'Arguments', presentation: 'Presentation' }, presentation: { help: 'Customize the title and icon shown on Stream Deck. The fallback applies only to the title: empty uses the localized command name.', fallback: 'Title-only fallback: empty uses the command name localized in that language.', icon: { label: 'Icon', hint: 'Unknown icons remain available for replacement or removal.', none: 'No icon', settings: 'Settings', chat: 'Chat', folder: 'Folder', play: 'Play', stop: 'Stop', back: 'Back', star: 'Star', unavailable: 'Icon unavailable: {{icon}}' }, locales: { ptBR: 'Português (Brasil)', en: 'English', es: 'Español' }, invalid: 'Review the custom titles before saving.', invalidNul: 'The title cannot contain the NUL character.', invalidLength: 'The title must be at most 256 codepoints.' }, scope: { label: 'Scope', global: 'Global', workspace: 'Current workspace' }, priority: 'Layer priority: {{value}}',
