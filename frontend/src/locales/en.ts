  ...
  translation: {
    ...
    profiles: {
      ...
      chatSection: {
        ...
        rateLimitRpmHint: 'Maximum sustained rate of LLM calls for this profile.',
        rateLimitBurst: 'Maximum burst',
        rateLimitBurstHint: 'Consecutive calls allowed before waiting. For agentic tasks, use at least the expected number of iterations.',
