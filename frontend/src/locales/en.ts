const en = {
  translation: {
    ...
    commandSettings: {
      ...
      formExtra: { effect: 'Effect', execute: 'Execute', suppress: 'Suppress', arguments: 'Arguments', presentation: 'Presentation' }, scope: { label: 'Scope', global: 'Global', workspace: 'Current workspace' }, priority: 'Layer priority: {{value}}',
