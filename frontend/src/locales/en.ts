  ...
  translation: {
    ...
    channels: {
      ...
      sip: {
        ...
        denoise: 'Noise reduction (denoise)',
        agc: 'Automatic gain control (AGC)',
        noiseSuppressDb: 'Noise suppression (dB)',
        noiseSuppressDbHint: 'The more negative, the more aggressive the cleanup. Recommended default: -24 dB.',
        agcTarget: 'AGC target',
        agcMaxGainDb: 'AGC max gain (dB)',
        agcHint: 'Adjusts captured audio level before STT. A higher target makes speech louder; max gain limits excessive compensation.',
        vadMode: 'VAD mode (0-3)',
        vadSpeechMs: 'Minimum speech (ms)',
        vadSilenceMs: 'Silence to end (ms)',
        vadHint: 'WebRTC VAD becomes more aggressive at higher values. Silence controls how long to wait before closing the segment.',
        bargeInThreshold: 'Barge-in threshold',
        bargeInThresholdHint: 'Minimum RMS to interrupt TTS when the caller talks over it. Typical range: 0.10 to 0.20.',
