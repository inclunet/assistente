const en = {
  translation: {
    ...
    subagents: {
      pageTitle: 'Sub-agents',
      loading: 'Loading sub-agents...',
      empty: 'No sub-agents yet. They show up here when the assistant delegates tasks to their own sub-conversations.',
