  ...
  useTranslation: () => ({
    t: (key: string) => {
      const translations: Record<string, string> = {
        ...
        'profiles.chatSection.debugDumpsEnabledHint': 'Grava dados do caminho OpenAI Responses localmente em .assistente/debug/llm-dumps.',
        ...
        'profiles.chatSection.debugMaxFilesHint': 'Limita snapshots retidos.',
