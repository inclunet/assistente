...
import {profileaccess} from '../models';
import {wailsapi} from '../models';

export function AuthorizeJobProfile(arg1:string,arg2:string):Promise<boolean>;
...
export function RevokeJobProfile(arg1:string,arg2:string):Promise<void>;

export function RunJob(arg1:string):Promise<jobs.RunLog>;

export function SaveJob(arg1:string):Promise<wailsapi.SaveJobResult>;
