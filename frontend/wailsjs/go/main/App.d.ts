...
export function SIPActiveCalls():Promise<Array<sip.CallInfo>>;

export function SIPCall(arg1:string):Promise<sip.CallInfo>;

export function SIPHangup(arg1:string):Promise<void>;
