...
var getData = __name(function() {
  ...
  for (const section of sections2) {
    const node = {
      id: section.id,
      label: sanitizeText((_a = section.label) != null ? _a : "", conf),
      isGroup: true,
    ...
    for (const item of children) {
      const childNode = {
        id: item.id,
        parentId: section.id,
        label: sanitizeText((_b = item.label) != null ? _b : "", conf),
        isGroup: false,
...
var addNode = __name((level, id, descr, type, shapeData) => {
  var _a, _b, _c, _d;
  const conf = getConfig2();
  let padding = (_b = (_a = conf.mindmap) == null ? void 0 : _a.padding) != null ? _b : defaultConfig_default.mindmap.padding;
  switch (type) {
...
var draw = __name(async (text, id, _version, diagObj) => {
  ...
  setupGraphViewbox(
    void 0,
    svg,
    (_e = (_d = conf.mindmap) == null ? void 0 : _d.padding) != null ? _e : defaultConfig_default.kanban.padding,
    (_g = (_f = conf.mindmap) == null ? void 0 : _f.useMaxWidth) != null ? _g : defaultConfig_default.kanban.useMaxWidth
  );
}, "draw");
...
//# sourceMappingURL=kanban-definition-3W4ZIXB7-425YW3CS.js.map
