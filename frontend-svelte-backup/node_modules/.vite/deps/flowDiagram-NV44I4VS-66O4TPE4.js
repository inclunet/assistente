...
import {
  getDiagramElement
} from "./chunk-WLPLINFA.js";
import {
  setupViewPortForSVG
} from "./chunk-NT3WHRNR.js";
import {
  JSON_SCHEMA,
  load
...
var FlowDB = (_a = class {
  ...
  addSingleLink(_start, _end, type, id) {
    ...
    if (this.edges.length < ((_a2 = this.config.maxEdges) != null ? _a2 : 500)) {
...
You have to call mermaid.initialize.`
  ...
  updateLink(positions, style) {
    positions.forEach((pos) => {
      ...
      if (pos === "default") {
        ...
        if (((_c = (_b = (_a2 = this.edges[pos]) == null ? void 0 : _a2.style) == null ? void 0 : _b.length) != null ? _c : 0) > 0 && !((_e = (_d = this.edges[pos]) == null ? void 0 : _d.style) == null ? void 0 : _e.some((s) => s == null ? void 0 : s.startsWith("fill")))) {
  ...
  addSubGraph(_id, list, _title) {
    ...
    let dir = result.dir;
    const flowchartConfig = (_a2 = getConfig2().flowchart) != null ? _a2 : {};
    dir = dir != null ? dir : flowchartConfig.inheritDir ? (_c = (_b = this.getDirection()) != null ? _b : getConfig2().direction) != null ? _c : void 0 : void 0;
    if (this.version === "gen-1") {
      for (let i = 0; i < nodeList.length; i++) {
        nodeList[i] = this.lookUpDomId(nodeList[i]);
      }
    }
    id = id != null ? id : "subGraph" + this.subCount;
    title = title || "";
  ...
  addNodeFromVertex(vertex, nodes, parentDB, subGraphDB, config, look) {
    ...
    const isGroup = (_a2 = subGraphDB.get(vertex.id)) != null ? _a2 : false;
    ...
    if (node) {
      ...
      const baseNode = {
        ...
        labelStyle: "",
        parentId,
        padding: ((_b = config.flowchart) == null ? void 0 : _b.padding) || 8,
  ...
  getCompiledStyles(classDefs) {
    ...
    for (const customClass of classDefs) {
      ...
      if (cssClass == null ? void 0 : cssClass.styles) {
        compiledStyles = [...compiledStyles, ...(_a2 = cssClass.styles) != null ? _a2 : []].map((s) => s.trim());
      }
      if (cssClass == null ? void 0 : cssClass.textStyles) {
        compiledStyles = [...compiledStyles, ...(_b = cssClass.textStyles) != null ? _b : []].map((s) => s.trim());
      }
    }
  ...
  getData() {
    ...
    e.forEach((rawEdge, index) => {
      ...
      const styles = [...(_a2 = e.defaultStyle) != null ? _a2 : []];
      if (rawEdge.style) {
      ...
      const edge = {
        ...
        type: (_b = rawEdge.type) != null ? _b : "normal",
        label: rawEdge.text,
        labelpos: "c",
        ...
        curve: rawEdge.interpolate || this.edges.defaultInterpolate || ((_c = config.flowchart) == null ? void 0 : _c.curve)
      };
      edges.push(edge);
    });
...
var draw = __name(async function(text, id, _version, diag) {
  ...
  const padding = (_b = (_a2 = data4Layout.config.flowchart) == null ? void 0 : _a2.diagramPadding) != null ? _b : 8;
...
//# sourceMappingURL=flowDiagram-NV44I4VS-66O4TPE4.js.map
