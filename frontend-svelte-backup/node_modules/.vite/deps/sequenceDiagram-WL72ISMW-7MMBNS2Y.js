...
var SequenceDB = (_a = class {
  ...
  addBox(data) {
    ...
    this.state.records.boxes.push({
      name: data.text,
      wrap: (_a2 = data.wrap) != null ? _a2 : this.autoWrap(),
      fill: data.color,
      actorKeys: []
    });
  ...
  addActor(id, name, description, type, metadata) {
    ...
    type = (_a2 = doc == null ? void 0 : doc.type) != null ? _a2 : type;
    ...
    this.state.records.actors.set(id, {
      ...
      wrap: (_b = description.wrap) != null ? _b : this.autoWrap(),
      prevActor: this.state.records.prevActor,
      links: {},
      properties: {},
      actorCnt: null,
      rectData: null,
      type: type != null ? type : "participant"
    });
  ...
  addMessage(idFrom, idTo, message, answer) {
    ...
    this.state.records.messages.push({
      ...
      wrap: (_a2 = message.wrap) != null ? _a2 : this.autoWrap(),
      answer
    });
  }
  addSignal(idFrom, idTo, message, messageType, activate = false) {
    ...
    if (messageType === this.LINETYPE.ACTIVE_END) {
      const cnt = this.activationCount(idFrom != null ? idFrom : "");
      if (cnt < 1) {
    ...
    this.state.records.messages.push({
      ...
      from: idFrom,
      to: idTo,
      message: (_a2 = message == null ? void 0 : message.text) != null ? _a2 : "",
      wrap: (_b = message == null ? void 0 : message.wrap) != null ? _b : this.autoWrap(),
      type: messageType,
      activate
    });
    return true;
  ...
  autoWrap() {
    ...
    return (_b = (_a2 = getConfig2().sequence) == null ? void 0 : _a2.wrap) != null ? _b : false;
  }
  clear() {
    this.state.reset();
    clear();
  ...
  addNote(actor, placement, message) {
    ...
    this.state.records.messages.push({
      ...
      to: actors[1],
      message: message.text,
      wrap: (_b = message.wrap) != null ? _b : this.autoWrap(),
...
var drawActorTypeControl = __name(function(elem, actor, conf2, isFooter) {
  ...
  actor.height = bounds2.height + 2 * ((_b = (_a2 = conf2 == null ? void 0 : conf2.sequence) == null ? void 0 : _a2.labelBoxHeight) != null ? _b : 0);
  _drawTextCandidateFunc(conf2, hasKatex(actor.description))(
    actor.description,
    actElem,
    rect.x,
...
var drawActorTypeEntity = __name(function(elem, actor, conf2, isFooter) {
  ...
  const bounds2 = actElem.node().getBBox();
  actor.height = bounds2.height + ((_b = (_a2 = conf2 == null ? void 0 : conf2.sequence) == null ? void 0 : _a2.labelBoxHeight) != null ? _b : 0);
  if (!isFooter) {
    actorCnt++;
    line.append("line").attr("id", "actor" + actorCnt).attr("x1", center).attr("y1", centerY).attr("x2", center).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", actor.name);
    actor.actorCnt = actorCnt;
...
`;
  ...
  if (lastPath.node()) {
    const bounds2 = lastPath.node().getBBox();
    actor.height = bounds2.height + ((_b = conf2.sequence.labelBoxHeight) != null ? _b : 0);
  }
  return actor.height;
...
var drawActorTypeBoundary = __name(function(elem, actor, conf2, isFooter) {
  ...
  const bounds2 = actElem.node().getBBox();
  actor.height = bounds2.height + ((_a2 = conf2.sequence.labelBoxHeight) != null ? _a2 : 0);
  _drawTextCandidateFunc(conf2, hasKatex(actor.description))(
    actor.description,
    actElem,
    rect.x,
...
//# sourceMappingURL=sequenceDiagram-WL72ISMW-7MMBNS2Y.js.map
