import {
  ImperativeState
} from "./chunk-AR7KENOT.js";
import {
  populateCommonDb
} from "./chunk-VWKR4L3R.js";
import {
  parse
} from "./chunk-5MMVTUXO.js";
import "./chunk-KGY7ET2X.js";
import "./chunk-BCD3333D.js";
import "./chunk-DMZQXBIP.js";
import "./chunk-FPP55HZL.js";
import "./chunk-A2DXCLDC.js";
import "./chunk-7V6YH7RD.js";
import "./chunk-L3QRAV2X.js";
import "./chunk-M7ZVGYBB.js";
...
var commit = __name(function(commitDB) {
  ...
  const newCommit = {
    ...
    type: type != null ? type : commitType.NORMAL,
    tags: tags != null ? tags : [],
...
var checkout = __name(function(branch2) {
  ...
  if (!state.records.branches.has(branch2)) {
    ...
    if (id === void 0 || !id) {
      ...
      state.records.head = (_a = state.records.commits.get(id)) != null ? _a : null;
    }
  }
}, "checkout");
...
var parseBranch = __name((branch2) => {
  ...
  const branchDB = {
    name: branch2.name,
    order: (_a = branch2.order) != null ? _a : 0
  };
  return branchDB;
}, "parseBranch");
var parseMerge = __name((merge2) => {
  ...
  const mergeDB = {
    ...
    id: (_a = merge2.id) != null ? _a : "",
    type: merge2.type !== void 0 ? commitType[merge2.type] : void 0,
    tags: (_b = merge2.tags) != null ? _b : void 0
  };
  return mergeDB;
}, "parseMerge");
...
var getCommitClassType = __name((commit2) => {
  var _a;
  const commitSymbolType = (_a = commit2.customType) != null ? _a : commit2.type;
...
var calculatePosition = __name((commit2, dir2, pos, commitPos2) => {
  ...
  if (commit2.parents.length > 0) {
    ...
    if (closestParent) {
      const parentPosition = (_a = commitPos2.get(closestParent)) != null ? _a : defaultCommitPosition;
      if (dir2 === "TB") {
        return parentPosition.y + COMMIT_STEP;
      } else if (dir2 === "BT") {
        const currentPosition = (_b = commitPos2.get(commit2.id)) != null ? _b : defaultCommitPosition;
    ...
    if (dir2 === "TB") {
      ...
      const currentPosition = (_c = commitPos2.get(commit2.id)) != null ? _c : defaultCommitPosition;
      return currentPosition.y - COMMIT_STEP;
    } else {
      return 0;
    }
...
var drawCommits = __name((svg, commits, modifyGraph) => {
  ...
  const isParallelCommits = (_a = DEFAULT_GITGRAPH_CONFIG2 == null ? void 0 : DEFAULT_GITGRAPH_CONFIG2.parallelCommits) != null ? _a : false;
  const sortKeys = __name((a, b) => {
    var _a2, _b;
    const seqA = (_a2 = commits.get(a)) == null ? void 0 : _a2.seq;
  ...
  sortedKeys.forEach((key) => {
    ...
    if (modifyGraph) {
      ...
      const commitSymbolType = (_a2 = commit2.customType) != null ? _a2 : commit2.type;
      const branchIndex = (_c = (_b = branchPos.get(commit2.branch)) == null ? void 0 : _b.index) != null ? _c : 0;
...
var draw = __name(function(txt, id, ver, diagObj) {
  ...
  const rotateCommitLabel = (_a = DEFAULT_GITGRAPH_CONFIG2.rotateCommitLabel) != null ? _a : false;
  ...
  branches.forEach((branch2, index) => {
    ...
    (_a2 = label.node()) == null ? void 0 : _a2.appendChild(labelElement);
    const bbox = labelElement.getBBox();
  ...
  utils_default.insertTitle(
    diagram2,
    "gitTitleText",
    (_b = DEFAULT_GITGRAPH_CONFIG2.titleTopMargin) != null ? _b : 0,
    db2.getDiagramTitle()
  );
  setupGraphViewbox2(
    void 0,
...
//# sourceMappingURL=gitGraphDiagram-NY62KEGX-CYKOKZ3N.js.map
