...
var setAxes = __name((axes) => {
  data.axes = axes.map((axis) => {
    ...
    return {
      name: axis.name,
      label: (_a = axis.label) != null ? _a : axis.name
    };
  });
}, "setAxes");
var setCurves = __name((curves) => {
  data.curves = curves.map((curve) => {
    ...
    return {
      name: curve.name,
      label: (_a = curve.label) != null ? _a : curve.name,
...
var setOptions = __name((options) => {
  ...
  data.options = {
    showLegend: (_b = (_a = optionMap.showLegend) == null ? void 0 : _a.value) != null ? _b : defaultOptions.showLegend,
    ticks: (_d = (_c = optionMap.ticks) == null ? void 0 : _c.value) != null ? _d : defaultOptions.ticks,
    max: (_f = (_e = optionMap.max) == null ? void 0 : _e.value) != null ? _f : defaultOptions.max,
...
var draw = __name((_text, id, _version, diagram2) => {
  ...
  const maxValue = (_a = options.max) != null ? _a : Math.max(...curves.map((curve) => Math.max(...curve.entries)));
...
//# sourceMappingURL=diagram-QEK2KX5R-ZZHTFA2Y.js.map
