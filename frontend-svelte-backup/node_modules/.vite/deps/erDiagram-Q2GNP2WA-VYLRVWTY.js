  ...
  addEntity(name, alias = "") {
    ...
    if (!this.entities.has(name)) {
      this.entities.set(name, {
        ...
        alias,
        shape: "erBox",
        look: (_a2 = getConfig2().look) != null ? _a2 : "default",
        cssClasses: "default",
        cssStyles: []
      });
      log.info("Added new entity :", name);
    } else if (!((_b = this.entities.get(name)) == null ? void 0 : _b.alias) && alias) {
...
var draw = __name(async function(text, id, _version, diag) {
  ...
  setupViewPortForSVG(svg, padding, "erDiagram", (_b = conf == null ? void 0 : conf.useMaxWidth) != null ? _b : true);
}, "draw");
...
//# sourceMappingURL=erDiagram-Q2GNP2WA-VYLRVWTY.js.map
