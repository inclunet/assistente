import {
  getIconStyles
} from "./chunk-2V2Y46CX.js";
import {
  Graph,
  clone_default
} from "./chunk-NEIRUAT7.js";
import "./chunk-5OFWTICW.js";
import {
  getLineFunctionsWithOffset
} from "./chunk-JO3DBS5E.js";
import {
  getSubGraphTitleMargins
} from "./chunk-Z4TZAY4C.js";
import {
  createText,
  replaceIconSubstring
} from "./chunk-GWEKEVMX.js";
import "./chunk-GP2NYWAC.js";
import {
  decodeEntities,
  getStylesFromArray,
  utils_default
} from "./chunk-IZVVDRGW.js";
import "./chunk-Z66MI7BZ.js";
import {
  channel_default,
  clear,
  common_default,
  ...
  rgba_default,
  sanitizeText
} from "./chunk-DVKXTTTN.js";
import "./chunk-JNWHTGLC.js";
import {
  __name,
  basis_default,
  line_default,
  log,
  select_default
} from "./chunk-YDYGHGYH.js";
import "./chunk-YU2AOQ7T.js";
import "./chunk-SKVRTNDU.js";
...
var populateBlockDatabase = __name((_blockList, parent) => {
  ...
  const column = (_a2 = columnSettingBlock == null ? void 0 : columnSettingBlock.columns) != null ? _a2 : -1;
  for (const block of blockList) {
    ...
    if (block.type === "applyClass") {
      setCssClass(block.id, (_b2 = block == null ? void 0 : block.styleClass) != null ? _b2 : "");
      continue;
    }
    ...
    if (block.type === "column-setting") {
      parent.columns = (_c2 = block.columns) != null ? _c2 : -1;
    } else if (block.type === "edge") {
      const count = ((_d = edgeCount.get(block.id)) != null ? _d : 0) + 1;
      ...
      if (block.type === "space") {
        const w = (_e = block.width) != null ? _e : 1;
        for (let j = 0; j < w; j++) {
...
var _a, _b, _c;
var padding = (_c = (_b = (_a = getConfig2()) == null ? void 0 : _a.block) == null ? void 0 : _b.padding) != null ? _c : 8;
...
var getMaxChildSize = __name((block) => {
  ...
  for (const child of block.children) {
    const { width, height, x, y } = (_a2 = child.size) != null ? _a2 : { width: 0, height: 0, x: 0, y: 0 };
    log.debug(
    ...
    if (width > maxWidth) {
      maxWidth = width / ((_b2 = block.widthInColumns) != null ? _b2 : 1);
    }
    if (height > maxHeight) {
      maxHeight = height;
    }
...
function setBlockSizes(block, db2, siblingWidth = 0, siblingHeight = 0) {
  ...
  let maxWidth = 0;
  let maxHeight = 0;
  if (((_c2 = block.children) == null ? void 0 : _c2.length) > 0) {
    for (const child of block.children) {
    ...
    for (const child of block.children) {
      if (child.size) {
        ...
        child.size.width = maxWidth * ((_d = child.widthInColumns) != null ? _d : 1) + padding * (((_e = child.widthInColumns) != null ? _e : 1) - 1);
    ...
    const columns = (_f = block.columns) != null ? _f : -1;
    let numItems = 0;
    for (const child of block.children) {
    ...
    log.debug(
      `abc95 (finale calc) ${block.id} xSize ${xSize} ySize ${ySize} columns ${columns}${block.children.length} width=${Math.max(width, ((_h = block.size) == null ? void 0 : _h.width) || 0)}`
    );
    if (width < (((_i = block == null ? void 0 : block.size) == null ? void 0 : _i.width) || 0)) {
      width = ((_j = block == null ? void 0 : block.size) == null ? void 0 : _j.width) || 0;
      const num = columns > 0 ? Math.min(block.children.length, columns) : block.children.length;
      if (num > 0) {
        const childWidth = (width - num * padding - padding) / num;
        log.debug("abc95 (growing to fit) width", block.id, width, (_k = block.size) == null ? void 0 : _k.width, childWidth);
        for (const child of block.children) {
          if (child.size) {
            child.size.width = childWidth;
          }
  ...
  log.debug(
    ...
    block.id,
    (_l = block == null ? void 0 : block.size) == null ? void 0 : _l.x,
    (_m = block == null ? void 0 : block.size) == null ? void 0 : _m.width,
    (_n = block == null ? void 0 : block.size) == null ? void 0 : _n.y,
    (_o = block == null ? void 0 : block.size) == null ? void 0 : _o.height
  );
}
...
function layoutBlocks(block, db2) {
  ...
  log.debug(
    `abc85 layout blocks (=>layoutBlocks) ${block.id} x: ${(_a2 = block == null ? void 0 : block.size) == null ? void 0 : _a2.x} y: ${(_b2 = block == null ? void 0 : block.size) == null ? void 0 : _b2.y} width: ${(_c2 = block == null ? void 0 : block.size) == null ? void 0 : _c2.width}`
  );
  const columns = (_d = block.columns) != null ? _d : -1;
  log.debug("layoutBlocks columns abc95", block.id, "=>", columns, block);
  if (block.children && block.children.length > 0) {
    const width = (_g = (_f = (_e = block == null ? void 0 : block.children[0]) == null ? void 0 : _e.size) == null ? void 0 : _f.width) != null ? _g : 0;
    const widthOfChildren = block.children.length * width + (block.children.length - 1) * padding;
    log.debug("widthOfChildren 88", widthOfChildren, "posX");
    let columnPos = 0;
    log.debug("abc91 block?.size?.x", block.id, (_h = block == null ? void 0 : block.size) == null ? void 0 : _h.x);
    let startingPosX = ((_i = block == null ? void 0 : block.size) == null ? void 0 : _i.x) ? ((_j = block == null ? void 0 : block.size) == null ? void 0 : _j.x) + (-((_k = block == null ? void 0 : block.size) == null ? void 0 : _k.width) / 2 || 0) : -padding;
    let rowPos = 0;
    for (const child of block.children) {
      const parent = block;
      if (!child.size) {
      ...
      if (py != rowPos) {
        rowPos = py;
        startingPosX = ((_l = block == null ? void 0 : block.size) == null ? void 0 : _l.x) ? ((_m = block == null ? void 0 : block.size) == null ? void 0 : _m.x) + (-((_n = block == null ? void 0 : block.size) == null ? void 0 : _n.width) / 2 || 0) : -padding;
        log.debug("New row in layout for block", block.id, " and child ", child.id, rowPos);
      }
      log.debug(
        `abc89 layout blocks (child) id: ${child.id} Pos: ${columnPos} (px, py) ${px},${py} (${(_o = parent == null ? void 0 : parent.size) == null ? void 0 : _o.x},${(_p = parent == null ? void 0 : parent.size) == null ? void 0 : _p.y}) parent: ${parent.id} width: ${width2}${padding}`
      );
      if (parent.size) {
        const halfWidth = width2 / 2;
        child.size.x = startingPosX + padding + halfWidth;
        log.debug(
          `abc91 layout blocks (calc) px, pyid:${child.id} startingPos=X${startingPosX} new startingPosX${child.size.x} ${halfWidth} padding=${padding} width=${width2} halfWidth=${halfWidth} => x:${child.size.x} y:${child.size.y} ${child.widthInColumns} (width * (child?.w || 1)) / 2 ${width2 * ((_q = child == null ? void 0 : child.widthInColumns) != null ? _q : 1) / 2}`
        );
        startingPosX = child.size.x + halfWidth;
        child.size.y = parent.size.y - parent.size.height / 2 + py * (height + padding) + height / 2 + padding;
        log.debug(
          `abc88 layout blocks (calc) px, pyid:${child.id}startingPosX${startingPosX}${padding}${halfWidth}=>x:${child.size.x}y:${child.size.y}${child.widthInColumns}(width * (child?.w || 1)) / 2${width2 * ((_r = child == null ? void 0 : child.widthInColumns) != null ? _r : 1) / 2}`
        );
      }
      if (child.children) {
  ...
  log.debug(
    `layout blocks (<==layoutBlocks) ${block.id} x: ${(_t = block == null ? void 0 : block.size) == null ? void 0 : _t.x} y: ${(_u = block == null ? void 0 : block.size) == null ? void 0 : _u.y} width: ${(_v = block == null ? void 0 : block.size) == null ? void 0 : _v.width}`
  );
}
...
var class_box = __name(async (parent, node) => {
  ...
  classAttributes.forEach((lbl) => {
    ...
    verticalPos += ((_a3 = memberBBox == null ? void 0 : memberBBox.height) != null ? _a3 : 0) + rowPadding;
  });
  verticalPos += lineHeight;
...
function getNodeFromBlock(block, db2, positioned = false) {
  ...
  const styles = getStylesFromArray((_c2 = vertex == null ? void 0 : vertex.styles) != null ? _c2 : []);
  const vertexText = vertex.label;
  const bounds = (_d = vertex.size) != null ? _d : { width: 0, height: 0, x: 0, y: 0 };
  const node = {
    ...
    intersect: void 0,
    type: vertex.type,
    padding: (_g = padding2 != null ? padding2 : (_f = (_e = getConfig()) == null ? void 0 : _e.block) == null ? void 0 : _f.padding) != null ? _g : 0
  };
  return node;
}
...
//# sourceMappingURL=blockDiagram-VD42YOAC-OQBOPKNX.js.map
