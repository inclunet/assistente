...
function addNodes(nodes, cy) {
  nodes.forEach((node) => {
    ...
    cy.add({
      ...
      data: nodeData,
      position: {
        x: (_b = node.x) != null ? _b : 0,
        y: (_c = node.y) != null ? _c : 0
      }
    });
  });
}
...
var render = __name(async (data4Layout, svg, {
  ...
  await Promise.all(
    data4Layout.edges.map(async (edge) => {
      ...
      const startNode = nodeDb[(_a = edge.start) != null ? _a : ""];
      const endNode = nodeDb[(_b = edge.end) != null ? _b : ""];
...
//# sourceMappingURL=cose-bilkent-S5V4N54A-X4C2OVLJ.js.map
