...
var TreeMapDB = (_a = class {
  ...
  getConfig() {
    ...
    return cleanAndMerge({
      ...
      ...(_a2 = userConfig.treemap) != null ? _a2 : {}
    });
  }
  addNode(node, level) {
    var _a2;
    ...
    if (level === 0) {
      ...
      (_a2 = this.root) != null ? _a2 : this.root = node;
    }
  }
  getRoot() {
  ...
  addClass(id, _style) {
    var _a2;
    const styleClass = (_a2 = this.classes.get(id)) != null ? _a2 : { id, styles: [], textStyles: [] };
  ...
  getStylesForClass(classSelector) {
    var _a2, _b;
    return (_b = (_a2 = this.classes.get(classSelector)) == null ? void 0 : _a2.styles) != null ? _b : [];
  }
  clear() {
    clear();
    this.nodes = [];
...
var populate = __name((ast, db) => {
  ...
  const items = [];
  for (const row of (_a2 = ast.TreemapRows) != null ? _a2 : []) {
    if (row.$type === "ClassDefStatement") {
      db.addClass((_b = row.className) != null ? _b : "", (_c = row.styleText) != null ? _c : "");
    }
  }
  for (const row of (_d = ast.TreemapRows) != null ? _d : []) {
    const item = row.item;
    if (!item) {
      continue;
    }
...
var draw = __name((_text, id, _version, diagram2) => {
  ...
  const treemapInnerPadding = (_a2 = config.padding) != null ? _a2 : DEFAULT_INNER_PADDING;
  ...
  const hierarchyRoot = hierarchy(root).sum((d) => {
    var _a3;
    return (_a3 = d.value) != null ? _a3 : 0;
  }).sort((a, b) => {
    var _a3, _b2;
    return ((_a3 = b.value) != null ? _a3 : 0) - ((_b2 = a.value) != null ? _b2 : 0);
  });
  ...
  const diagramPadding = (_b = config.diagramPadding) != null ? _b : 8;
...
//# sourceMappingURL=diagram-PSM6KHXK-I32Y2EMU.js.map
