...
var ArchitectureDB = (_a = class {
  ...
  getNode(id) {
    var _a2;
    return (_a2 = this.nodes[id]) != null ? _a2 : null;
  }
      ...
      const adjList = Object.entries(this.nodes).reduce((prevOuter, [id, service]) => {
        prevOuter[id] = service.edges.reduce((prevInner, edge) => {
          ...
          if (lhsGroupId && rhsGroupId && lhsGroupId !== rhsGroupId) {
            ...
            if (alignment !== "bend") {
              (_c = groupAlignments[lhsGroupId]) != null ? _c : groupAlignments[lhsGroupId] = {};
...
function getAlignments(db, spatialMaps, groupAlignments) {
        ...
        for (let i = 0; i < arr.length - 1; i++) {
          for (let j = i + 1; j < arr.length; j++) {
            ...
            if (alignment === alignmentDir) {
              (_b = prev[dir]) != null ? _b : prev[dir] = [];
              prev[dir] = [...prev[dir], ...aNodeIds, ...bNodeIds];
            } else if (aGroupId === "default" || bGroupId === "default") {
              (_c = prev[dir]) != null ? _c : prev[dir] = [];
              prev[dir] = [...prev[dir], ...aNodeIds, ...bNodeIds];
            } else {
              const keyA = `${dir}-${cnt++}`;
              prev[keyA] = aNodeIds;
  ...
  const alignments = spatialMaps.map((spatialMap) => {
    ...
    Object.entries(spatialMap).forEach(([id, [x, y]]) => {
      ...
      const nodeGroup = (_b = (_a2 = db.getNode(id)) == null ? void 0 : _a2.in) != null ? _b : "default";
      (_c = horizontalAlignments[y]) != null ? _c : horizontalAlignments[y] = {};
      (_e = (_d = horizontalAlignments[y])[nodeGroup]) != null ? _e : _d[nodeGroup] = [];
      horizontalAlignments[y][nodeGroup].push(id);
      (_f = verticalAlignments[x]) != null ? _f : verticalAlignments[x] = {};
      (_h = (_g = verticalAlignments[x])[nodeGroup]) != null ? _h : _g[nodeGroup] = [];
...
//# sourceMappingURL=architectureDiagram-VXUJARFQ-N3D2OWSY.js.map
