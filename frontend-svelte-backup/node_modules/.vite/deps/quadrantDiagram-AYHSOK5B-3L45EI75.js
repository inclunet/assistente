  ...
  getQuadrantPoints(spaceData) {
    ...
    const points = this.data.points.map((point) => {
      ...
      const props = {
        x: xAxis(point.x),
        y: yAxis(point.y),
        fill: (_a3 = point.color) != null ? _a3 : this.themeConfig.quadrantPointFill,
        radius: (_b = point.radius) != null ? _b : this.config.pointRadius,
        text: {
          text: point.text,
        ...
        strokeColor: (_c = point.strokeColor) != null ? _c : this.themeConfig.quadrantPointFill,
        strokeWidth: (_d = point.strokeWidth) != null ? _d : "0px"
      };
      return props;
    });
    return points;
...
var draw = __name((txt, id, _version, diagObj) => {
  ...
  const width = (_b = (_a3 = conf.quadrantChart) == null ? void 0 : _a3.chartWidth) != null ? _b : 500;
  const height = (_d = (_c = conf.quadrantChart) == null ? void 0 : _c.chartHeight) != null ? _d : 500;
  configureSvgSize(svg, height, width, (_f = (_e = conf.quadrantChart) == null ? void 0 : _e.useMaxWidth) != null ? _f : true);
...
//# sourceMappingURL=quadrantDiagram-AYHSOK5B-3L45EI75.js.map
