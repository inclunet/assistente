...
var draw = __name(function(text, id, _version, diagObj) {
  ...
  const width = (_a4 = conf == null ? void 0 : conf.width) != null ? _a4 : defaultSankeyConfig.width;
...
${prefix}${Math.round(value2 * 100) / 100}${suffix}`;
  ...
  const linkColor = (_h = conf == null ? void 0 : conf.linkColor) != null ? _h : "gradient";
...
//# sourceMappingURL=sankeyDiagram-TZEHDZUN-4462LO4Q.js.map
