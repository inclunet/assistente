...
import {
  selectSvgElement
} from "./chunk-NUFOJ5UF.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-PI2QDJGJ.js";
import {
  registerLayoutLoaders
} from "./chunk-W7QZXOYF.js";
import "./chunk-FZVHVALH.js";
import "./chunk-MRUBH46L.js";
import "./chunk-JO3DBS5E.js";
import "./chunk-Z4TZAY4C.js";
import "./chunk-CU6H2PKP.js";
import {
  dedent,
  registerIconPacks
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-YG6GDRKO-LOP5P5ZV.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-NV44I4VS-66O4TPE4.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-Q2GNP2WA-VYLRVWTY.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-NY62KEGX-CYKOKZ3N.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-JELNMOA3-S2JJQFSR.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-WHAUD3N6-3OLJGSXD.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-ADFJNKIX-AOVAM2IW.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-AYHSOK5B-3L45EI75.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-PRI3JC2R-CF7YTSJ3.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-UZGBJVZJ-YLGTE43C.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-WL72ISMW-7MMBNS2Y.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-2ON5EDUG-QV7YKMLK.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-WZHVMYZB-DVNFTZMH.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-FKZM4ZOC-YCYLPD5C.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-4FDKWEC3-WFN2ROIN.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-XKPGCS4Q-U2OFY2V2.js");
...
var detector18 = __name((txt, config = {}) => {
  var _a2;
  if (/^\s*flowchart-elk/.test(txt) || /^\s*(flowchart|graph)/.test(txt) && ((_a2 = config == null ? void 0 : config.flowchart) == null ? void 0 : _a2.defaultRenderer) === "elk") {
    config.layout = "elk";
    return true;
  }
  return false;
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-IT6M3QCI-LHVXJ6XI.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-VGOIOE7T-HHVWAEXK.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-3W4ZIXB7-425YW3CS.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-TZEHDZUN-4462LO4Q.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-S2PKOQOG-EJFUFCG4.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-QEK2KX5R-ZZHTFA2Y.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-VD42YOAC-OQBOPKNX.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-VXUJARFQ-N3D2OWSY.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-PSM6KHXK-I32Y2EMU.js");
...
var processDirectives = __name((code) => {
  var _a2;
  const initDirective = (_a2 = utils_default.detectInit(code)) != null ? _a2 : {};
...
var render = __name(async function(id28, text, svgContainingElement) {
  ...
  const config = getConfig();
  log.debug(config);
  if (text.length > ((_a2 = config == null ? void 0 : config.maxTextSize) != null ? _a2 : MAX_TEXTLENGTH)) {
  ...
  const diagramClassDefs = (_c = (_b = diag.renderer).getClasses) == null ? void 0 : _c.call(_b, text, diag);
