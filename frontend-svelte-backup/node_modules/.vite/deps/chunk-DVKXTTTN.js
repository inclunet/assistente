...
var hasKatex = __name((text) => {
  var _a8, _b;
  return ((_b = (_a8 = text.match(katexRegex)) == null ? void 0 : _a8.length) != null ? _b : 0) > 0;
}, "hasKatex");
...
var renderKatexUnsanitized = __name(async (text, config2) => {
  ...
  if (true) {
    const { default: katex } = await import("./katex-LDYRXHHG.js");
...
//# sourceMappingURL=chunk-DVKXTTTN.js.map
