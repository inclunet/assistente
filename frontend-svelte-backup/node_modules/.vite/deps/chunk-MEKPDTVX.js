...
var draw = __name(async function(text, id, _version, diag) {
  ...
  try {
    ...
    links.forEach((linkInfo, key) => {
      ...
      const allNodes = (_a3 = svg.node()) == null ? void 0 : _a3.querySelectorAll("g");
      let matchedElem;
      allNodes == null ? void 0 : allNodes.forEach((g) => {
        var _a4;
        const text2 = (_a4 = g.textContent) == null ? void 0 : _a4.trim();
        if (text2 === stateId) {
          matchedElem = g;
        }
      });
  ...
  utils_default.insertTitle(
    ...
    (_a2 = conf == null ? void 0 : conf.titleTopMargin) != null ? _a2 : 25,
    diag.db.getDiagramTitle()
  );
  setupViewPortForSVG(svg, padding, CSS_DIAGRAM, (_b = conf == null ? void 0 : conf.useMaxWidth) != null ? _b : true);
}, "draw");
      ...
      case STMT_RELATION:
        {
          ...
          const edgeData = {
            ...
            style: G_EDGE_STYLE,
            labelStyle: "",
            label: common_default.sanitizeText((_a2 = item.description) != null ? _a2 : "", getConfig2()),
...
function insertOrUpdateNode(nodes, nodeData, classes) {
  ...
  if (nodeData.cssClasses) {
    ...
    nodeData.cssClasses.split(" ").forEach((cssClass) => {
      ...
      if (classDef) {
        nodeData.cssCompiledStyles = [...(_a2 = nodeData.cssCompiledStyles) != null ? _a2 : [], ...classDef.styles];
      }
    });
  }
...
function getClassesFromDbInfo(dbInfoItem) {
  var _a2, _b;
  return (_b = (_a2 = dbInfoItem == null ? void 0 : dbInfoItem.classes) == null ? void 0 : _a2.join(" ")) != null ? _b : "";
}
__name(getClassesFromDbInfo, "getClassesFromDbInfo");
function getStylesFromDbInfo(dbInfoItem) {
  var _a2;
  return (_a2 = dbInfoItem == null ? void 0 : dbInfoItem.styles) != null ? _a2 : [];
}
...
var StateDB = (_a = class {
  ...
  getDirection() {
    var _a2, _b;
    return (_b = (_a2 = this.getDirectionStatement()) == null ? void 0 : _a2.value) != null ? _b : DEFAULT_DIAGRAM_DIRECTION;
  }
  setDirection(dir) {
...
//# sourceMappingURL=chunk-MEKPDTVX.js.map
