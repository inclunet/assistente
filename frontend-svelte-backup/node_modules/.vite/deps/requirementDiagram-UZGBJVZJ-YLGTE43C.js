...
var RequirementDB = (_a = class {
  ...
  setCssStyle(ids, styles) {
    var _a2;
    for (const id of ids) {
      const node = (_a2 = this.requirements.get(id)) != null ? _a2 : this.elements.get(id);
      if (!styles || !node) {
        return;
      }
    ...
    for (const id of ids) {
      ...
      if (node) {
        for (const _class of classNames) {
          ...
          const styles = (_b = this.classes.get(_class)) == null ? void 0 : _b.styles;
          if (styles) {
  ...
  getData() {
    ...
    for (const relation of this.relations) {
      ...
      const edge = {
        ...
        start: (_c = (_a2 = this.requirements.get(relation.src)) == null ? void 0 : _a2.name) != null ? _c : (_b = this.elements.get(relation.src)) == null ? void 0 : _b.name,
        end: (_f = (_d = this.requirements.get(relation.dst)) == null ? void 0 : _d.name) != null ? _f : (_e = this.elements.get(relation.dst)) == null ? void 0 : _e.name,
        label: `&lt;&lt;${relation.type}&gt;&gt;`,
...
var draw = __name(async function(text, id, _version, diag) {
  ...
  data4Layout.nodeSpacing = (_a2 = conf == null ? void 0 : conf.nodeSpacing) != null ? _a2 : 50;
  data4Layout.rankSpacing = (_b = conf == null ? void 0 : conf.rankSpacing) != null ? _b : 50;
  ...
  utils_default.insertTitle(
    ...
    (_c = conf == null ? void 0 : conf.titleTopMargin) != null ? _c : 25,
    diag.db.getDiagramTitle()
  );
  setupViewPortForSVG(svg, padding, "requirementDiagram", (_d = conf == null ? void 0 : conf.useMaxWidth) != null ? _d : true);
}, "draw");
var diagram = {
...
//# sourceMappingURL=requirementDiagram-UZGBJVZJ-YLGTE43C.js.map
