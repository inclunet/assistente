...
var draw = __name(function(text, id, version, diagObj) {
  ...
  function getEstimatedTickCount(minTime, maxTime, every, interval) {
    ...
    const intervalMs = import_dayjs2.default.duration({ [interval != null ? interval : "day"]: every }).asMilliseconds();
    if (intervalMs <= 0) {
      return Infinity;
    }
  ...
  function makeGrid(theSidePad, theTopPad, w2, h2) {
    ...
    if (userAxisFormat) {
      ...
      axisFormat2 = (_a = conf.axisFormat) != null ? _a : "%Y-%m-%d";
    }
...
//# sourceMappingURL=ganttDiagram-JELNMOA3-S2JJQFSR.js.map
