  ...
  getData() {
    ...
    for (const namespaceKey of this.namespaces.keys()) {
      ...
      if (namespace) {
        const node = {
          ...
          label: namespace.id,
          isGroup: true,
          padding: (_a3 = config.class.padding) != null ? _a3 : 16,
          shape: "rect",
    ...
    for (const note of this.notes) {
      ...
      const noteNode = {
        ...
        isGroup: false,
        shape: "note",
        padding: (_b = config.class.padding) != null ? _b : 6,
        cssStyles: [
          "text-align: left",
          "white-space: nowrap",
      ...
      nodes.push(noteNode);
      const noteClassId = (_d = (_c = this.classes.get(note.class)) == null ? void 0 : _c.id) != null ? _d : "";
      if (noteClassId) {
        const edge = {
          id: `edgeNote${cnt}`,
          start: note.id,
...
var draw = __name(async function(text, id, _version, diag) {
  ...
  utils_default.insertTitle(
    ...
    (_a3 = conf == null ? void 0 : conf.titleTopMargin) != null ? _a3 : 25,
    diag.db.getDiagramTitle()
  );
  setupViewPortForSVG(svg, padding, "classDiagram", (_b = conf == null ? void 0 : conf.useMaxWidth) != null ? _b : true);
}, "draw");
...
//# sourceMappingURL=chunk-TXUFNN6A.js.map
