...
var MindmapDB = (_a = class {
  ...
  addNode(level, id, descr, type) {
    ...
    let padding = (_b = (_a2 = conf.mindmap) == null ? void 0 : _a2.padding) != null ? _b : defaultConfig_default.mindmap.padding;
    switch (type) {
    ...
    const node = {
      ...
      type,
      children: [],
      width: (_d = (_c = conf.mindmap) == null ? void 0 : _c.maxNodeWidth) != null ? _d : defaultConfig_default.mindmap.maxNodeWidth,
      padding,
      isRoot
    };
  ...
  flattenNodes(node, processedNodes) {
    ...
    const processedNode = {
      ...
      width: node.width,
      height: (_a2 = node.height) != null ? _a2 : 0,
...
var draw = __name(async (text, id, _version, diagObj) => {
  ...
  setupViewPortForSVG(
    svg,
    (_b = (_a2 = data4Layout.config.mindmap) == null ? void 0 : _a2.padding) != null ? _b : defaultConfig_default.mindmap.padding,
    "mindmapDiagram",
    (_d = (_c = data4Layout.config.mindmap) == null ? void 0 : _c.useMaxWidth) != null ? _d : defaultConfig_default.mindmap.useMaxWidth
  );
}, "draw");
...
//# sourceMappingURL=mindmap-definition-VGOIOE7T-HHVWAEXK.js.map
