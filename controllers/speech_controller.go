...
func (c *SpeechController) SpeakMessage(messageID string, providerID, model, voiceID string, rate float64) (*speech.AudioResult, error) {
	return c.speechSvc.SpeakMessage(messageID, providerID, model, voiceID, rate)
}
