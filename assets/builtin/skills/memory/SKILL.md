...
name: memory-manager
version: 2.0.0
description: "Gerencia proativamente a memória do assistente: salva decisões, preferências e contexto automaticamente e organiza rollups temporais."
...
| Padrões e convenções | Descobriu que o projeto usa BEM para CSS | `memory.md` seção Preferências |
...
**Como comunicar:** Uma linha breve no meio da resposta: "Salvei na memória: [resumo curto]." — não peça confirmação, não faça disso o foco.
